...
namespace Server
{
	public struct Serial : IComparable, IComparable<Serial>
	{
		...
		private static Serial m_LastItem = (Serial)0x40000000;
		...
		public static Serial NewMobile
		{
			get
			{
				while ( World.FindMobile( m_LastMobile = (Serial)(m_LastMobile + 1) ) != null );
		...
		public static Serial NewItem
		{
			get
			{
				while ( World.FindItem( m_LastItem = (Serial)(m_LastItem + 1) ) != null );
		...
		public static explicit operator Serial( int a )
		{
			return new Serial( a );
		}
	}
