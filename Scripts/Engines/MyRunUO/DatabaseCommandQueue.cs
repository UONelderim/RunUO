...
namespace Server.Engines.MyRunUO
{
	public class DatabaseCommandQueue
	{
		...
		public DatabaseCommandQueue( string connectionString, string completionString, string threadName )
		{
			...
			/*m_Queue.Enqueue( "DELETE FROM runuo_characters" );
			m_Queue.Enqueue( "DELETE FROM runuo_characters_layers" );
			m_Queue.Enqueue( "DELETE FROM runuo_characters_skills" );
			m_Queue.Enqueue( "DELETE FROM runuo_guilds" );
			m_Queue.Enqueue( "DELETE FROM runuo_guilds_wars" );*/
