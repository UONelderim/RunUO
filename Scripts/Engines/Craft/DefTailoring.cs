...
namespace Server.Engines.Craft
{
	public class DefTailoring : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			AddCraft( typeof( ElvenShirt ), 1015269, "elegancka koszula" , 80.0, 110.0, typeof( Cloth ), 1044286, 8, 1044287 );
			...
			AddCraft( typeof( MaleElvenRobe ), 1015269, "elegancka szata z kapturem" , 80.0, 110.0, typeof( Cloth ), 1044286, 20, 1044287 );
			AddCraft( typeof( FemaleElvenRobe ), 1015269, "elegancka szata" , 80.0, 110.0, typeof( Cloth ), 1044286, 18, 1044287 );
			...
			//AddCraft( typeof(koshoola), 1015269, "elegancka koszula bez wzoru", 26.0, 51.0, typeof( Cloth ), 1044286, 16, 1044287 );
			...
			AddCraft( typeof( ElvenPants ), 1015279, "eleganckie spodnie" , 80.0, 110.0, typeof( Cloth ), 1044286, 6, 1044287 );
			...
			AddCraft( typeof( WoodlandBelt ), 1015283, "leśny pas" , 80.0, 110.0, typeof( Cloth ), 1044286, 15, 1044287 );
            ...
            // szczaw :: 2013.01.13 :: Dodanie AddPackDeed
            index = AddCraft( typeof(AddPackDeed), 1015283, "juki", 40, 80, typeof(Leather), 1044462, 50);
            AddRes(index, typeof(Cloth), 1044286, 50 );
			...
			AddCraft( typeof( ElvenBoots ), 1015288, "eleganckie buty" , 80.0, 110.0, typeof( Leather ), 1044462, 10, 1044463 );
			#endregion
			...
			#region Leaf Armour
			AddCraft( typeof( LeafArms ), "Leśne zbroje" , "leśne naramienniki" , 80.0, 110.0, typeof( Leather ), 1044462, 8, 1044463 );
			AddCraft( typeof( LeafGorget ), "Leśne zbroje", "leśny karczek", 80.0, 110.0, typeof( Leather ), 1044462, 4, 1044463 );
			AddCraft( typeof( LeafTonlet ), "Leśne zbroje", "leśna spódnica", 80.0, 110.0, typeof( Leather ), 1044462, 12, 1044463 );
			AddCraft( typeof( LeafGloves ), "Leśne zbroje", "leśne rękawice" , 80.0, 110.0, typeof( Leather ), 1044462, 3, 1044463 );
			AddCraft( typeof( LeafLegs ), "Leśne zbroje", "leśne nogawice" , 80.0, 110.0, typeof( Leather ), 1044462, 10, 1044463 );
			AddCraft( typeof( LeafChest ), "Leśne zbroje", "leśna tunika" , 80.0, 110.0, typeof( Leather ), 1044462, 12, 1044463 );
			AddCraft( typeof( HidePauldrons ), "Leśne zbroje" , "wzmocnione leśne naramienniki" , 80.0, 110.0, typeof( Leather ), 1044462, 8, 1044463 );
			AddCraft( typeof( HideGorget ), "Leśne zbroje", "wzmocniony leśny karczek", 80.0, 110.0, typeof( Leather ), 1044462, 4, 1044463 );
			AddCraft( typeof( HideFemaleChest ), "Leśne zbroje", "damska wzmocniona leśna tunika", 80.0, 110.0, typeof( Leather ), 1044462, 12, 1044463 );
			AddCraft( typeof( HideGloves ), "Leśne zbroje", "wzmocnione leśne rękawice" , 80.0, 110.0, typeof( Leather ), 1044462, 3, 1044463 );
			AddCraft( typeof( HidePants ), "Leśne zbroje", "wzmocnione leśne spodnie" , 80.0, 110.0, typeof( Leather ), 1044462, 10, 1044463 );
			AddCraft( typeof( HideChest ), "Leśne zbroje", "wzmocniona leśna tunika" , 80.0, 110.0, typeof( Leather ), 1044462, 12, 1044463 );
			#endregion
			...
			index = AddCraft( typeof( OrcHelm ), 1049149, "orczy helm" , 85.0, 110.0, typeof( Leather ), 1044462, 4, 1044463 );
