...
namespace Server.Engines.Craft
{
	public class DefCartography : CraftSystem
	{
		...
		public override void InitCraftList()
		{
			...
			//AddCraft( typeof( SeaNavigator ), "nawigacja", "nawigator morski", 90.0, 99.5, typeof( IronIngot ), 1044449, 100, 1044450 );

            // Blank scrolls
            int index = AddCraft(typeof(BlankScroll), 1044294, 1044377, 40.0, 80.0, typeof(Cloth), 1044286, 1, 1044253);
