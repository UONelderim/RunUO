...
namespace Server.Engines.Craft
{
	public class DefTinkering : CraftSystem
	{
		...
		public override bool ResourcesUnlocked(Mobile from, Type typeRes1, Type typeRes2)
		{
			//PlayerMobile pm = from as PlayerMobile;
			//if (from != null && typeRes1 != null && typeRes1 != typeof(IronIngot))
			//	return pm.ColorMetal;
		...
		private static Type[] m_TinkerColorables = new Type[]
			{
				...
				typeof( HeatingStand ),
				// 09.09.2013 :: mortuus - wszystkie narzedzia dziedzicza kolor po metalu:
				typeof( BaseTool ), typeof( BaseHarvestTool )
			};
		...
		public override bool RetainsColorFrom( CraftItem item, Type type )
		{
			...
			// 09.09.2013 :: mortuus - umozliwienie dziedziczenia koloru dla calych grup itemow (dla klasy nadrzednej)
			for ( int i = 0; !contains && i < m_TinkerColorables.Length; ++i )
				contains = ( m_TinkerColorables[i] == type || type.IsSubclassOf(m_TinkerColorables[i]) );
		...
		public void AddJewelrySet( GemType gemType, Type itemType )
		{
			...
			index = AddCraft( typeof( GoldRing ), 1044049, "pierscien" , 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			index = AddCraft( typeof( SilverRing ), 1044049, "pierscien" , 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			index = AddCraft( typeof( GoldBracelet ), 1044049, "branzoleta" , 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			index = AddCraft( typeof( SilverBracelet ), 1044049, "branzoleta" , 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			index = AddCraft( typeof( SilverBeadNecklace ), 1044049, "naszyjnik", 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			index = AddCraft( typeof( SilverNecklace ), 1044049, "naszyjnik", 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			index = AddCraft( typeof( GoldBeadNecklace ), 1044049, "naszyjnik", 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
			index = AddCraft( typeof( GoldNecklace ), 1044049, "naszyjnik", 40.0, 90.0, typeof( IronIngot ), 1044036, 2, 1044037 );
		...
		public override void InitCraftList()
		{
            ...
            /*index = AddCraft( typeof( WandTools ), 1044046, 1032600, 50.0, 100.0, typeof( IronIngot ), 1044036, 1, 1044037);*/
            AddRes(index, typeof( Log ), 1044041, 2, 1044351);
			index = AddCraft( typeof( BivalviaNet ), 1044046, 1031011, 10.0, 60.0, typeof( IronIngot ), 1044036, 1, 1044037);
            ...
            // wedka:
            index = AddCraft(typeof(FishingPole), 1044046, 1023519, 40.0, 90.0, typeof(Log), 1044041, 5, 1044351);
            AddRes(index, typeof(Cloth), 1044286, 5, 1044287);
            // narzedzia kamieniarza:
            index = AddCraft(typeof(MalletAndChisel), 1044046, 1044515, 40.0, 90.0, typeof(IronIngot), 1044036, 4, 1044037);

			index = AddCraft(typeof(Blowpipe), 1044046, "rura do wydmuchiwania szkla", 40.0, 90.0, typeof(IronIngot), 1044036, 4, 1044037);
            ...
            // 31.10.2012 :: zombie
            index = AddCraft(typeof(TaxidermyKit), 1044046, 1041279, 60.0, 90.0, typeof(Log), 1015101, 50, 1044253);
			AddRes( index, typeof( Cloth ), 1044286, 50, 1044253 );
            AddRes( index, typeof( IronIngot ), 1044036, 50, 1044253 );
			AddRes( index, typeof( ZoogiFungus ), 1054145, 1, 1044253 );
            // zombie
			...
			AddCraft( typeof ( Pitchfork ), 1044050, "Widly", 50.0, 90.0, typeof( IronIngot ), 1044036, 16, 1044037 );
			AddCraft( typeof( KnifeLeft ), 1044048, 1044162, 0.0, 50.0, typeof( IronIngot ), 1044036, 1, 1044037 );
			AddCraft( typeof( KnifeRight ), 1044048, "noz obracany w prawo", 0.0, 50.0, typeof( IronIngot ), 1044036, 1, 1044037 );
            ...
            // Latarnia maga
            index = AddCraft(typeof(ShieldLanternDeed), 1044050, ShieldLanternDeed.NameText, 70.0, 100.0, typeof(BlankScroll), "czyste zwoje", 1, 1044253);
            ...
            // Runiczny kostur
            index = AddCraft(typeof(RunicStaffDeed), 1044050, RunicStaffDeed.NameText, 70.0, 100.0, typeof(BlankScroll), "czyste zwoje", 1, 1044253);
