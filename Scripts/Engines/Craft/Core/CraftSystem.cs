...
namespace Server.Engines.Craft
{
	...
	public abstract class CraftSystem
	{
        ...
        private RecycleHelper m_RecycleHelper;
        ...
        public virtual RecycleHelper RecycleHelper
        {
            get { return m_RecycleHelper; }
            set { m_RecycleHelper = value; }
        }

		public bool Recycle
		{
            get { return m_RecycleHelper != null; }
			//set { m_Resmelt = value; }
		}
		...
		public virtual bool ResourcesUnlocked(Mobile from, Type typeRes1, Type typeRes2)
		{
			return true;
		}
	}
