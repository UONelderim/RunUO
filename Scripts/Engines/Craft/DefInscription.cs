...
namespace Server.Engines.Craft
{
    public class DefInscription : CraftSystem
    {
        ...
        private void AddMagerySpell(int spell, int circle, int mana, Type type, int[] amounts, params Type[] regs)
        {
            ...
            if (circle <= 2) group = 1071068; // 1-2 krag
        ...
        {
            // 04.07.2012 :: zombie :: przebudowa, dodanie nowych regow
           ...
           //Okultyzm
            index = AddCraft( typeof( UndeadAngelicFaithScroll ), 1044294, "Demoniczny Awatar", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            ...
            index = AddCraft( typeof( UndeadVolcanicEruptionScroll ), 1044294, "Erupcja Wulkaniczna", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadSwarmOfInsectsScroll ), 1044294, "Chmara Insektów", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadSeanceScroll ), 1044294, "Seans", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadNaturesPassageScroll ), 1044294, "Ścieżka Śmierci", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadMushroomGatewayScroll ), 1044294, "Limbo", 90.0, 120.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadLureStoneScroll ), 1044294, "Gnijące Zwłoki", 90.0, 120.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadLeafWhirlwindScroll ), 1044294, "Piętno", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            index = AddCraft( typeof( UndeadHollowReedScroll ), 1044294, "Hedonizm", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadHammerOfFaithScroll ), 1044294, "Sierp Wiary Smierci", 90.0, 120.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadGraspingRootsScroll ), 1044294, "Uchwyt Zza Grobu", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( UndeadCauseFearScroll ), 1044294, "Strach", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );

            //Avatar
            index = AddCraft( typeof( AvatarSacredBoonScroll ), 1044294, "Święty znak", 80.0, 110.0, typeof( Corruption ), "korupcja" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AvatarRestorationScroll ), 1044294, "Odrodzenie", 80.0, 110.0, typeof( Corruption ), "korupcja" , 20, 1044253 );
            AddRes( index, typeof( DaemonBone ), "kości demona" , 50, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AvatarMarkOfGodsScroll ), 1044294, "Znak Bogów", 80.0, 110.0, typeof( WyrmsHeart ), "Serce Wyrma" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AvatarHeavensGateScroll ), 1044294, "Niebiańska Brama", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            ...
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AvatarEnemyOfOneSpell ), 1044294, "Naznaczony", 25.0, 76.0, typeof( Corruption ), "korupcja" , 20, 1044253 );
            AddRes( index, typeof( DaemonBone ), "kości demona" , 50, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AvatarArmysPaeonSpell  ), 1044294, "Witalność Armii", 80.0, 110.0, typeof( WyrmsHeart ), "Serce Wyrma" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AvatarAngelicFaithSpell ), 1044294, "Awatar Pradawnego Mnicha", 60.0, 100.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );

            //Druid
            index = AddCraft( typeof( DruidBlendWithForestScroll  ), 1044294, "Jedność Z Lasem", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby" , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            index = AddCraft( typeof( DruidFamiliarScroll ), 1044294, "Przywołanie Przyjaciela Lasu", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( DragonsBlood ), "krew smoka" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidEnchantedGroveScroll), 1044294, "Zaklęty Gaj", 90.0, 120.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidGraspingRootsScroll), 1044294, "Szalone Korzenie", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidHollowReedScroll), 1044294, "Siła Natury", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidLeafWhirlwindScroll ), 1044294, "Wir Liści", 90.0, 120.0, typeof( LuminescentFungi ), "lśniące grzyby", 20 , 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( DarkSapphire ), "ciemny szafir" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidLureStoneScroll ), 1044294, "Ciekawy kamie", 90.0, 120.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidMushroomGatewayScroll ), 1044294, "Przejście Natury", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            index = AddCraft( typeof( DruidNaturesPassageScroll), 1044294, "Naznaczenie", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidPackOfBeastScroll), 1044294, "Leśne Bestyje", 60.0, 90.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( DragonsBlood ), "krew smoka" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidRestorativeSoilScroll ), 1044294, "Lecznicza Ziemia", 90.0, 120.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidShieldOfEarthScroll ), 1044294, "Tarcza Ziemi", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30,1044253 );
            AddRes( index, typeof( DragonsBlood ), "krew smoka" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidSpringOfLifeScroll ), 1044294, "Źródło życia", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( DragonsBlood ), "krew smoka" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidStoneCircleScroll ), 1044294, "Kamienny Krąg", 90.0, 120.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( DragonsBlood ), "krew smoka" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidSwarmOfInsectsScroll ), 1044294, "Chmara Insektów", 80.0, 110.0, typeof( LuminescentFungi ), "lśniące grzyby"  , 20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( DruidVolcanicEruptionScroll ), 1044294, "Erupcja Wulkaniczna", 90.0, 120.0, typeof( LuminescentFungi ), "lśniące grzyby"  ,20, 1044253 );
            AddRes( index, typeof( SpringWater ), "wiosenna woda" , 30, 1044253 );
            AddRes( index, typeof( DragonsBlood ), "krew smoka" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );

            //Ranger
            index = AddCraft( typeof( RangerSummonMountScroll ), 1044294, "Przyzwanie Wierzcha", 80.0, 110.0, typeof( DryIce ), "suchy lód" , 20, 1044253 );
            AddRes( index, typeof( DreadHornMane ), "Grzywa Spaczonego" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( RangerPhoenixFlightScroll ), 1044294, "Lot Feniksa", 80.0, 110.0, typeof( DryIce ), "suchy lód" , 20, 1044253 );
            AddRes( index, typeof( TeleportScroll ), "zwoje teleporatcji" , 20, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( RangerFamiliarScroll ), 1044294, "Zwierzęcy kompan", 80.0, 110.0, typeof( DryIce ), "suchy lód" , 20, 1044253 );
            AddRes( index, typeof( DreadHornMane ), "Grzywa Spaczonego" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( RangerNoxBowScroll ), 1044294, "Wężowy Łuk", 80.0, 110.0, typeof( DryIce ), "suchy lód" , 20, 1044253 );
            AddRes( index, typeof( DreadHornMane ), "Grzywa Spaczonego" , 10, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( RangerLightningBowScroll ), 1044294, "Piorunujący Łuk", 80.0, 110.0, typeof( DryIce ), "suchy lód" , 20, 1044253 );
            AddRes( index, typeof( DreadHornMane ), "Grzywa Spaczonego" , 10, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( RangerIceBowScroll ), 1044294, "Lodowy Łuk", 80.0, 110.0, typeof( DryIce ), "suchy lód" , 20, 1044253 );
            AddRes( index, typeof( DreadHornMane ), "Grzywa Spaczonego" , 10, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( RangerFireBowScroll ), 1044294, "Ognisty Łuk", 80.0, 110.0, typeof( DryIce ), "suchy lód" , 20, 1044253 );
            AddRes( index, typeof( DreadHornMane ), "Grzywa Spaczonego" , 10, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( RangerHuntersAimScroll ), 1044294, "Celność łowcy", 80.0, 110.0, typeof( DryIce ), "suchy lód" , 20, 1044253 );
            AddRes( index, typeof( DreadHornMane ), "Grzywa Spaczonego" , 10, 1044253 );
            AddRes( index, typeof( ParasiticPlant ), "paraliżujący bluszcz" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );

            //Ancient
            index = AddCraft( typeof( AncientCloneScroll ), 1044294, "Klonowanie", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            index = AddCraft( typeof( AncientDanceScroll ), 1044294, "Taniec", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientDeathVortexScroll), 1044294, "Wir Śmierci", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientSeanceScroll ), 1044294, "Seans", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientDouseSpell), 1044294, "Wygaszenie", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientFireRingScroll), 1044294, "Pierścień Ognia", 90.0, 120.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientEnchantScroll ), 1044294, "Magiczne Nasycenie", 90.0, 120.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientGreatDouseScroll ), 1044294, "Większe Wygaszenie", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            index = AddCraft( typeof( AncientGreatIgniteScroll ), 1044294, "Większe Podpalenie", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientIgniteScroll ), 1044294, "Podpalenie", 90.0, 120.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientMassMightSpell ), 1044294, "Masowa Potęga", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientCauseFearScroll ), 1044294, "Strach", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientPeerScroll ), 1044294, "Wizja", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( AncientSwarmScroll ), 1044294, "Rój", 90.0, 120.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );

            //Bard
            index = AddCraft( typeof( BardArmysPaeonScroll ), 1044294, "Śpiew Armii", 80.0, 110.0, typeof( Corruption ), "korupcja" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardEnchantingEtudeScroll), 1044294, "Wzmacniająca Etiuda", 80.0, 110.0, typeof( Corruption ), "korupcja" , 20, 1044253 );
            AddRes( index, typeof( DaemonBone ), "kości demona" , 50, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardEnergyCarolScroll ), 1044294, "Pobudzająca Pieśń", 80.0, 110.0, typeof( WyrmsHeart ), "Serce Wyrma" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardEnergyThrenodyScroll ), 1044294, "Porażający Tren", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( GateTravelScroll ), "zwoje bramy" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardFireThrenodyScroll ), 1044294, "Palący Tren", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            index = AddCraft( typeof( BardFoeRequiemScroll ), 1044294, "Soniczny Podmuch", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardIceCarolScroll), 1044294, "Pieśń Lodu", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardIceThrenodyScroll ), 1044294, "Lodowy Tren", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardKnightsMinneScroll ), 1044294, "Wzmacniający Okrzyk", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardMagesBalladScroll ), 1044294, "Pieśń Do Magów", 80.0, 110.0, typeof( Corruption ), "korupcja" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardMagicFinaleScroll ), 1044294, "Magiczny Finał", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardPoisonCarolScroll), 1044294, "Wężowa Pieśń", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardPoisonThrenodyScroll ), 1044294, "Tren Jadu", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardSheepfoeMamboScroll ), 1044294, "Pasterska Przyśpiewka", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( BardSinewyEtudeScroll ), 1044294, "Przyśpiewka Górników", 80.0, 110.0, typeof( Taint ), "skaza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );

            //Cleric
            index = AddCraft( typeof( ClericAngelicFaithScroll ), 1044294, "Anielska Wiara", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            index = AddCraft( typeof( ClericBanishEvilScroll ), 1044294, "Wygnanie zła", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericDampenSpiritScroll), 1044294, "Stłumienie Ducha", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericDivineFocusScroll ), 1044294, "Boskie Skupienie", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericHammerOfFaithScroll), 1044294, "Topór Wiary", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( ZoogiFungus ), "grzyby zoogi" , 50, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericPurgeScroll ), 1044294, "Czystka", 90.0, 120.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericRestorationScroll ), 1044294, "Odrodzenie", 90.0, 120.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericSacredBoonScroll ), 1044294, "Święty znak", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            index = AddCraft( typeof( ClericSacrificeScroll ), 1044294, "Poświęcenie", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 10, 1044253 );
            AddRes( index, typeof( FireRuby ), "ognisty rubin" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericSmiteScroll ), 1044294, "Smagnięcie", 90.0, 120.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericTouchOfLifeScroll ), 1044294, "Dotyk Życia", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );
            index = AddCraft( typeof( ClericTrialByFireScroll ), 1044294, "Próba Ognia", 80.0, 110.0, typeof( Blight ), "zaraza" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 10, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            AddRes( index, typeof( Gold ), "złoto" , 2000, 1044253 );

            //Rogue
            index = AddCraft( typeof( RogueFalseCoinScroll ), 1044294, "Falszywa moneta", 50.0, 70.0, typeof( Gold ), "zloto" , 2000, 1044253 );
            AddRes( index, typeof( Pumice ), "pumeks" , 20, 1044253 );
            ...
            index = AddCraft( typeof( RogueCharmScroll), 1044294, "Zaklecie", 70.0, 100.0, typeof( Gold ), "zloto" , 2000, 1044253 );
            AddRes( index, typeof( ObsidianStone ), "obysdian" , 20, 1044253 );
            AddRes( index, typeof( GrizzledBones ), "blade kości" , 1, 1044253 );
            index = AddCraft( typeof( RogueSlyFoxScroll ), 1044294, "Przebiegła forma", 70.0, 100.0, typeof( Gold ), "zloto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgniła kora" , 1, 1044253 );
            index = AddCraft( typeof( RogueShadowScroll ), 1044294, "Cien", 70.0, 100.0, typeof( Gold ), "zloto" , 2000, 1044253 );
            AddRes( index, typeof( BladeSpiritsScroll ), "zwoj ducha ostrzy" , 5, 1044253 );
            AddRes( index, typeof( DiseasedBark ), "zgnila kora" , 1, 1044253 );
            index = AddCraft( typeof( RogueIntimidationScroll ), 1044294, "Zastraszenie", 70.0, 100.0, typeof( Gold ), "zloto" , 2000, 1044253 );
            AddRes( index, typeof( CapturedEssence ), "złapana esencja" , 2, 1044253 );
