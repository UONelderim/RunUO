	...
	public class HonorContext
	{
		...
		public void OnTargetDamaged( Mobile from, int amount )
		{
			...
			if ( m_Poisoned )
			{
                ...
                m_TotalDamage += (int)Math.Round((double)amount * 0.15);
			...
			if ( from == m_Source )
			{
				...
				else
				{
                    ...
                    m_HonorDamageTwentieths += amount * 10;
				}
			}
		...
		public void OnTargetKilled()
		{
            ...
            if (m_Source.Virtues.Honor > targetFame && targetFame < 1000)
				return;
            ...
            int gain = Math.Min((int)dGain, 1500);
