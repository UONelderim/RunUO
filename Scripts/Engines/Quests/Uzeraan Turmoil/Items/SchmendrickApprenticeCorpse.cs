...
namespace Server.Engines.Quests.Haven
{
	public class SchmendrickApprenticeCorpse : Corpse
	{
		...
		{
			m_HairHue = None.Instance.RandomHairHue();

			return new HairInfo( None.Instance.RandomHair( false ), m_HairHue );
		}
		...
		private static FacialHairInfo GetFacialHair()
		{
			...
			return new FacialHairInfo( None.Instance.RandomFacialHair( false ), m_HairHue );
		}
