...
namespace Server.Items
{
	public class AncientFarmersKasa : Kasa
	{
		...
		{
			Name = "Kapelusz Tasandorskiego Znawcy Zwierząt";
			Hue = 115;
	...
	public class ArmsOfTacticalExcellence : LeatherHiroSode
	{
		...
		{
			Name = "Naramienniki Tasandorskiego Taktyka";
			Hue = 33;
	...
	public class DaimyosHelm : PlateBattleKabuto
	{
		...
		{
			Name = "Czepiec Starożytnego Wojownika";
			Hue = 77;
			ArmorAttributes.LowerStatReq = 100;
			ArmorAttributes.MageArmor = 1;
