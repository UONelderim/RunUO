	...
	public class SmallTailorBOD : SmallBOD
	{
		...
		public static SmallTailorBOD CreateRandomFor( Mobile m )
		{
			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials && theirSkill >= 70.1 )
				{
					for ( int i = 0; i < 20; ++i )
					{
						BulkMaterialType check = GetRandomMaterial(BulkMaterialType.None, BulkMaterialType.Spined, m_TailoringMaterialChances );
						double skillReq = 0.0;
		...
		public SmallTailorBOD()
		{
			...
			if ( entries.Length > 0 )
			{
				...
				if ( useMaterials )
					material = GetRandomMaterial(BulkMaterialType.None, BulkMaterialType.Spined, m_TailoringMaterialChances );
				else
