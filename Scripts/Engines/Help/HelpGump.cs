...
namespace Server.Engines.Help
{
	public class ContainedMenu : QuestionMenu
	{
		...
		public ContainedMenu( Mobile from ) : base( "Wezwales juz pomoc. Przyslemy kogos, gdy tylko bedzie to mozliwe. Co chcialbys teraz zrobic?", new string[]{ "Zostaw moje wezwanie w kolejce.", "Usun moje wezwanie z kolejki." } )
		{
			m_From = from;
		}
	...
	public class HelpGump : Gump
	{
            ...
            : base(0, 0)
        {
            ...
            if (isYoung)
            {
                ...
                AddHtml(110, 270, 450, 58, @"<u>Another player is harassing me.</u> Another player is verbally harassing your character. When you select this option you will be sending a text log to Origin Systems. To see what constitutes harassment please visit http://www.nelderim.pl" , true, true);

                AddButton(80, 335, 5540, 5541, 0, GumpButtonType.Page, 2);
                AddHtml(110, 335, 450, 58, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page (located at  http://www.nelderim.pl, please use this option.", true, true);
            }
            else
            {
                ...
                AddHtml(110, 250, 450, 74, @"<u>Another player is harassing me.</u> Another player is verbally harassing your character. When you select this option you will be sending a text log to Origin Systems. To see what constitutes harassment please visit http://www.nelderim.pl", true, true);

                AddButton(80, 330, 5540, 5541, 0, GumpButtonType.Page, 2);
                AddHtml(110, 330, 450, 74, @"<u>Other.</u> If you are experiencing a problem in the game that does not fall into one of the other categories or is not addressed on the Support web page http://www.nelderim.pl", true, true);
            }
                ...
                case 9: // Young player transport
                    {
                       ...
                       /*     if (from.Region.IsPartOf<Regions.Jail>())
                           ...
                           /* else if (from.Region.IsPartOf("Tasandora"))
                            {
                                from.SendLocalizedMessage(1041529); // You're already in Haven
                            }
                            else*/
                            {
                                from.MoveToWorld(new Point3D(1416, 1863, 32), Map.Felucca);
                            }
                        }
