...
namespace Server.Gumps
{
	...
	public class AdminGump : Gump
	{
		...
		private const int BlueAHue = 91;
		private const int BlueBHue = 95;
		private const int BlueCHue = 93;
		private const int BlueDHue = 98;
		...
		public static int GetHueFor( Mobile m )
		{
			...
			{
				case AccessLevel.Owner: return 0x846;
				case AccessLevel.Developer: return 0x8A4;
				case AccessLevel.Administrator: return 0x84C;
				case AccessLevel.Seer: return 0x144;
				case AccessLevel.GameMaster: return 0x3C;
				case AccessLevel.Counselor: return 0x35;
		...
		public AdminGump( Mobile from, AdminGumpPage pageType, int listPage, ArrayList list, string notice, object state ) : base( 50, 40 )
		{
			...
			AddPageButton( 10, 10, GetButtonID( 0, 0 ), "INFORMACJE", AdminGumpPage.Information_General, AdminGumpPage.Information_Perf );
			AddPageButton( 10, 30, GetButtonID( 0, 1 ), "ADMINISTRATOR", AdminGumpPage.Administer, AdminGumpPage.Administer_Access, AdminGumpPage.Administer_Commands, AdminGumpPage.Administer_Server, AdminGumpPage.Administer_WorldBuilding, AdminGumpPage.Administer_Access_Lockdown );
			AddPageButton( 10, 50, GetButtonID( 0, 2 ), "LISTA GRAJACYCH", AdminGumpPage.Clients, AdminGumpPage.ClientInfo );
			AddPageButton( 10, 70, GetButtonID( 0, 3 ), "LISTA KONT", AdminGumpPage.Accounts, AdminGumpPage.Accounts_Shared, AdminGumpPage.AccountDetails, AdminGumpPage.AccountDetails_Information, AdminGumpPage.AccountDetails_Characters, AdminGumpPage.AccountDetails_Access, AdminGumpPage.AccountDetails_Access_ClientIPs, AdminGumpPage.AccountDetails_Access_Restrictions, AdminGumpPage.AccountDetails_Comments, AdminGumpPage.AccountDetails_Tags, AdminGumpPage.AccountDetails_ChangeAccess, AdminGumpPage.AccountDetails_ChangePassword );
			AddPageButton( 10, 90, GetButtonID( 0, 4 ), "ZABEZPIECZENIE", AdminGumpPage.Firewall, AdminGumpPage.FirewallInfo );
			...
			switch ( pageType )
			{
				case AdminGumpPage.Information_General:
				{
					...
					AddLabel( 20, 130, LabelHue, "Aktywne Konta:" );
					AddLabel( 150, 130, LabelHue, active.ToString() );

					AddLabel( 20, 150, LabelHue, "Zablokowane Konta:" );
					AddLabel( 150, 150, LabelHue, banned.ToString() );

					AddLabel( 20, 170, LabelHue, "Zabezpieczina:" );
					...
					AddLabel( 20, 270, LabelHue, "Skrypty Przedmiotow:" );
					AddLabel( 150, 270, LabelHue, Core.ScriptItems.ToString() );

					AddLabel( 20, 290, LabelHue, "Czas Uruchomienia:" );
					AddLabel( 150, 290, LabelHue, FormatTimeSpan( DateTime.Now - ServerTime.ServerStart ) );

					AddLabel( 20, 310, LabelHue, "Pamiec:" );
					...
					AddLabel( 20, 350, LabelHue, "System Operacyjny: " );
				...
				case AdminGumpPage.Information_Perf:
				{
					...
					AddPageButton( 200, 20, GetButtonID( 0, 0 ), "Glowne", AdminGumpPage.Information_General );
					AddPageButton( 200, 40, GetButtonID( 0, 5 ), "Wydajnosc", AdminGumpPage.Information_Perf );

					break;
				}
				case AdminGumpPage.Administer_WorldBuilding:
				{
					AddHtml( 10, 125, 400, 20, Color( Center( "Generowanie" ), LabelColor32 ), false, false );

					AddButtonLabeled( 20, 150, GetButtonID( 3, 100 ), "Dokumentacja" );
					AddButtonLabeled( 220, 150, GetButtonID( 3, 107 ), "Rebuild Categorization" );

					AddButtonLabeled( 20, 175, GetButtonID( 3, 101 ), "Teleportery" );
					AddButtonLabeled( 220, 175, GetButtonID( 3, 102 ), "Publiczne Portale" );

					AddButtonLabeled( 20, 200, GetButtonID( 3, 103 ), "Wendorzy" );
					AddButtonLabeled( 220, 200, GetButtonID( 3, 106 ), "Dekoracje" );

					AddButtonLabeled( 20, 225, GetButtonID( 3, 104 ), "Drzwi" );
					AddButtonLabeled( 220, 225, GetButtonID( 3, 105 ), "Znaki" );
/*
...
*/
					...
					AddHtml( 20, 300, 400, 30, Color( Center( "Statyczne" ), LabelColor32 ), false, false );

					AddButtonLabeled( 20, 315, GetButtonID( 3, 110 ), "Blokowanie" );
					AddButtonLabeled( 110, 350, GetButtonID( 3, 111 ), "Blokowanie (Calego swiata)" );

					AddButtonLabeled( 220, 315, GetButtonID( 3, 120 ), "Odblokowywanie" );

					goto case AdminGumpPage.Administer;
				}
				case AdminGumpPage.Administer_Server:
				{
					AddHtml( 10, 125, 400, 20, Color( Center( "Serwer" ), LabelColor32 ), false, false );

					AddButtonLabeled( 20, 150, GetButtonID( 3, 200 ), "Zapis" );

					AddButtonLabeled( 20, 180, GetButtonID( 3, 201 ), "Wylacz + save" );
					AddButtonLabeled( 20, 200, GetButtonID( 3, 202 ), "Wylacz - save" );
					AddButtonLabeled( 20, 220, GetButtonID( 3, 205 ), "Wylacz za 120s" );
	
					AddButtonLabeled( 20, 250, GetButtonID( 3, 203 ), "Restart + save" );
					AddButtonLabeled( 20, 270, GetButtonID( 3, 204 ), "Restart - save" );
					AddButtonLabeled( 20, 290, GetButtonID( 3, 206 ), "Restart za 120s" );
					AddButtonLabeled( 20, 310, GetButtonID( 3, 207 ), "Restart + kompilacja przed resartem" );
					
					AddHtml( 90, 215, 400, 20, Color( Center( "Wiadomosc" ), LabelColor32 ), false, false );

					AddTextField( 20, 355, 380, 20, 0 );
					AddButtonLabeled( 220, 250, GetButtonID( 3, 210 ), "Do Wszystkich" );
					AddButtonLabeled( 220, 270, GetButtonID( 3, 211 ), "Do Ekipy" );

					goto case AdminGumpPage.Administer;
				}
				case AdminGumpPage.Administer_Access_Lockdown:
				{
					AddHtml( 10, 125, 400, 20, Color( Center( "Blokowanie Serwera" ), LabelColor32 ), false, false );
					...
					AddSelectedButton( 20, 230, GetButtonID( 3, 500 ), "Nie Zablokowany", !isLockedDown );
					...
					AddButtonLabeled( 20, 350, GetButtonID( 3, 510 ), "Rozlacz Reszte" );

					goto case AdminGumpPage.Administer;
				}
				case AdminGumpPage.Administer_Access:
				{
					AddHtml( 10, 125, 400, 20, Color( Center( "Uprawnienia" ), LabelColor32 ), false, false );

					AddHtml( 10, 155, 400, 20, Color( Center( "Sterowanie" ), LabelColor32 ), false, false );

					AddButtonLabeled(  20, 180, GetButtonID( 3, 300 ), "Wywal" );
					AddButtonLabeled( 220, 180, GetButtonID( 3, 301 ), "Zablokoj" );

					AddButtonLabeled(  20, 210, GetButtonID( 3, 302 ), "Firewall" );
					AddButtonLabeled( 220, 210, GetButtonID( 3, 303 ), "Lockdown" );

					AddHtml( 10, 245, 400, 20, Color( Center( "Ustawianie Uprawnien" ), LabelColor32 ), false, false );

					AddButtonLabeled( 20, 270, GetButtonID( 3, 310 ), "Ustaw Jako Player" );
					AddButtonLabeled( 20, 290, GetButtonID( 3, 311 ), "Ustaw Jako Counselor" );
					AddButtonLabeled( 20, 310, GetButtonID( 3, 312 ), "Ustaw Jako Game Master" );
					AddButtonLabeled( 20, 330, GetButtonID( 3, 313 ), "Ustaw Jako Seer" );

					if ( from.AccessLevel > AccessLevel.Administrator )
					{
						AddButtonLabeled( 220, 270, GetButtonID( 3, 314 ), "Ustaw Jako Administrator" );

						if ( from.AccessLevel > AccessLevel.Developer )
						{
							AddButtonLabeled( 220, 290, GetButtonID( 3, 315 ), "Ustaw Jako Developer" );

							if ( from.AccessLevel >= AccessLevel.Owner )
								AddButtonLabeled( 220, 310, GetButtonID( 3, 316 ), "Ustaw Jako Wlasciciel" );
						}
					}
				...
				{
					AddHtml( 10, 125, 400, 20, Color( Center( "Komendy" ), LabelColor32 ), false, false );

					AddButtonLabeled(  20, 150, GetButtonID( 3, 400 ), "Menu Dodawania" );
					AddButtonLabeled( 220, 150, GetButtonID( 3, 401 ), "Usun" );

					AddButtonLabeled(  20, 170, GetButtonID( 3, 402 ), "Kopiuj" );
					AddButtonLabeled( 220, 170, GetButtonID( 3, 403 ), "Kopiuj do Plecaka" );

					AddButtonLabeled(  20, 200, GetButtonID( 3, 404 ), "Ustawienia" );
					AddButtonLabeled( 220, 200, GetButtonID( 3, 405 ), "Umiejetnosci" );

					AddButtonLabeled(  20, 230, GetButtonID( 3, 406 ), "smiertelny" );
					AddButtonLabeled( 220, 230, GetButtonID( 3, 407 ), "Niesmiertelny" );

					AddButtonLabeled(  20, 250, GetButtonID( 3, 408 ), "Niemowa" );
					AddButtonLabeled( 220, 250, GetButtonID( 3, 409 ), "Rozmawiajacy" );

					AddButtonLabeled(  20, 270, GetButtonID( 3, 410 ), "Zamrozenie" );
					AddButtonLabeled( 220, 270, GetButtonID( 3, 411 ), "Odmrozenia" );

					AddButtonLabeled(  20, 290, GetButtonID( 3, 412 ), "Niewidoczny" );
					AddButtonLabeled( 220, 290, GetButtonID( 3, 413 ), "Widoczny" );

					AddButtonLabeled(  20, 310, GetButtonID( 3, 414 ), "Zabij" );
					AddButtonLabeled( 220, 310, GetButtonID( 3, 415 ), "Wskrzes" );

					AddButtonLabeled(  20, 330, GetButtonID( 3, 416 ), "Przestaw" );
					AddButtonLabeled( 220, 330, GetButtonID( 3, 417 ), "Usun" );

					AddButtonLabeled(  20, 350, GetButtonID( 3, 418 ), "Przenies" );
					AddButtonLabeled( 220, 350, GetButtonID( 3, 419 ), "Przenies (Wielokrotne)" );

					goto case AdminGumpPage.Administer;
				}
				case AdminGumpPage.Administer:
				{
					AddPageButton( 200, 20, GetButtonID( 3, 0 ), "Budowa swiata", AdminGumpPage.Administer_WorldBuilding );
					AddPageButton( 200, 40, GetButtonID( 3, 1 ), "Serwer", AdminGumpPage.Administer_Server );
					AddPageButton( 200, 60, GetButtonID( 3, 2 ), "Uprawnienia", AdminGumpPage.Administer_Access, AdminGumpPage.Administer_Access_Lockdown );
					AddPageButton( 200, 80, GetButtonID( 3, 3 ), "Komendy", AdminGumpPage.Administer_Commands );
				...
				case AdminGumpPage.Clients:
				{
					...
					AddLabelCropped(  12, 120, 81, 20, LabelHue, "Login" );
					AddLabelCropped( 110, 120, 81, 20, LabelHue, "Konto" );
					AddLabelCropped( 188, 120, 81, 20, LabelHue, "Uprawnienia" );
					AddLabelCropped( 273, 120,109, 20, LabelHue, "Adres IP" );
					...
					for ( int i = 0, index = (listPage * 12); i < 12 && index >= 0 && index < m_List.Count; ++i, ++index )
					{
						...
						AddLabelCropped( 110, offset, 81, 20, LabelHue, a == null ? "(no account)" : a.Username );
						AddLabelCropped( 188, offset, 81, 20, LabelHue, m == null ? (a != null ? FormatAccessLevel( a.AccessLevel ) : "") : FormatAccessLevel( m.AccessLevel ) );
				...
				case AdminGumpPage.ClientInfo:
				{
					...
					AddHtml( 10, 125, 400, 20, Color( Center( "Informacje" ), LabelColor32 ), false, false );

					int y = 146;

					AddLabel(  20, y, LabelHue, "Imie:" );
					AddLabel( 200, y, GetHueFor( m ), m.Name );
					y += 20;

					Account a = m.Account as Account;

					AddLabel(  20, y, LabelHue, "Konto:" );
					...
					if ( ns == null )
					{
						AddLabel(  20, y, LabelHue, "Adres:" );
						AddLabel( 200, y, RedHue, "Offline" );
						y += 18;

						AddLabel( 20, y, LabelHue, "Lokalizacja:" );
					...
					AddButtonLabeled(  20, y, GetButtonID( 7, 0 ), "Idz Do" );
					AddButtonLabeled( 200, y, GetButtonID( 7, 1 ), "Przyprowadz" );
					y += 20;

					AddButtonLabeled(  20, y, GetButtonID( 7, 2 ), "Wyrzuc" );
					AddButtonLabeled( 200, y, GetButtonID( 7, 3 ), "Zablokuj" );
					y += 20;

					AddButtonLabeled(  20, y, GetButtonID( 7, 4 ), "Ustawienia" );
					AddButtonLabeled( 200, y, GetButtonID( 7, 5 ), "Umiejetnosci" );
					y += 20;

					AddButtonLabeled(  20, y, GetButtonID( 7, 6 ), "smiertelny" );
					AddButtonLabeled( 200, y, GetButtonID( 7, 7 ), "Niesmiertelny" );
					y += 20;

					AddButtonLabeled(  20, y, GetButtonID( 7, 8 ), "Niemowa" );
					AddButtonLabeled( 200, y, GetButtonID( 7, 9 ), "Rozmawiajacy" );
					y += 20;
					...
					AddButtonLabeled(  20, y, GetButtonID( 7, 12 ), "Zabij" );
					AddButtonLabeled( 200, y, GetButtonID( 7, 13 ), "Wskrzes" );
					y += 20;
/*
					AddButtonLabeled(  20, y, GetButtonID( 7, 15 ), "Wiezienie" );
					AddButtonLabeled( 200, y, GetButtonID( 7, 16 ), "Uwolnij" );
					y += 20;
*/
					break;
				}
				case AdminGumpPage.Accounts_Shared:
				{
					...
					if ( m_List.Count == 0 )
						AddLabel( 12, 140, LabelHue, "Nie ma zadneko loginu o tej nazwie." );
				...
				case AdminGumpPage.Accounts:
				{
					...
					if ( rads == null )
						AddLabelCropped( 12, 120, 120, 20, LabelHue, "Login" );
					else
						AddLabelCropped( 32, 120, 100, 20, LabelHue, "Login" );

					AddLabelCropped( 132, 120, 120, 20, LabelHue, "Uprawnienia" );
					...
					{
						AddButtonLabeled( 10, 390, GetButtonID( 5, 27 ), "Zaznacz Blokade" );
						AddButtonLabeled( 10, 410, GetButtonID( 5, 28 ), "Usun Zaznaczone" );

						AddButtonLabeled( 210, 400, GetButtonID( 5, 29 ), "Zaznacz Wszystko" );
					}
					...
					for ( int i = 0, index = (listPage * 12); i < 12 && index >= 0 && index < m_List.Count; ++i, ++index )
					{
						...
						if ( online )
							...
							AddLabelCropped( 252, offset, 120, 20, RedHue, "Blokady" );
						else
				...
				{
					AddPageButton( 190, 10, GetButtonID( 5, 0 ), "Informacje", AdminGumpPage.AccountDetails_Information, AdminGumpPage.AccountDetails_ChangeAccess, AdminGumpPage.AccountDetails_ChangePassword );
					AddPageButton( 190, 30, GetButtonID( 5, 1 ), "Postacie", AdminGumpPage.AccountDetails_Characters );
					AddPageButton( 190, 50, GetButtonID( 5, 13 ), "Uzytkownicy", AdminGumpPage.AccountDetails_Access, AdminGumpPage.AccountDetails_Access_ClientIPs, AdminGumpPage.AccountDetails_Access_Restrictions );
					AddPageButton( 190, 70, GetButtonID( 5, 2 ), "Komentarz", AdminGumpPage.AccountDetails_Comments );
					AddPageButton( 190, 90, GetButtonID( 5, 3 ), "Opis", AdminGumpPage.AccountDetails_Tags );
					break;
				}
				case AdminGumpPage.AccountDetails_ChangePassword:
				{
					...
					AddHtml( 10, 125, 400, 20, Color( Center( "Zmien Haslo" ), LabelColor32 ), false, false );

					AddLabel(  20, 150, LabelHue, "Uzytkownik:" );
					AddLabel( 200, 150, LabelHue, a.Username );

					AddLabel( 20, 180, LabelHue, "Haslo:" );
					AddTextField( 200, 180, 160, 20, 0 );

					AddLabel( 20, 210, LabelHue, "Powtorz:" );
					AddTextField( 200, 210, 160, 20, 1 );

					AddButtonLabeled( 20, 240, GetButtonID( 5, 12 ), "Dokonaj Zmiany" );
				...
				case AdminGumpPage.AccountDetails_ChangeAccess:
				{
					...
					AddHtml( 10, 125, 400, 20, Color( Center( "Zmien Uprawnienia" ), LabelColor32 ), false, false );

					AddLabel(  20, 150, LabelHue, "Uzytkownik:" );
					AddLabel( 200, 150, LabelHue, a.Username );

					AddLabel(  20, 170, LabelHue, "Obecny Uprawnienia:" );
					...
					if ( from.AccessLevel > AccessLevel.Administrator )
					{
						...
						if ( from.AccessLevel > AccessLevel.Developer )
						{
							...
							if ( from.AccessLevel >= AccessLevel.Owner )
								AddButtonLabeled( 20, 320, GetButtonID( 5, 34 ), "Wlasciciel" );
						}
					}
				...
				case AdminGumpPage.AccountDetails_Information:
				{
					...
					AddLabel(  20, 170, LabelHue, "Uprawnienia:" );
					AddLabel( 200, 170, LabelHue, FormatAccessLevel( a.AccessLevel ) );

					DateTime nieakt_30 = DateTime.Now - TimeSpan.FromDays( 30.0 );
					DateTime nieakt_60 = DateTime.Now - TimeSpan.FromDays( 60.0 );
					DateTime nieakt_90 = DateTime.Now - TimeSpan.FromDays( 90.0 );
					DateTime nieakt_120 = DateTime.Now - TimeSpan.FromDays( 120.0 );
					DateTime nieakt_240 = DateTime.Now - TimeSpan.FromDays( 240.0 );

					AddLabel(  20, 190, LabelHue, "Status: " );
					//AddLabel( 200, 190, a.Banned ? RedHue : GreenHue, a.Banned ? "Zablokowany" : "Aktywny" );
					if ( nieakt_30 >= a.LastLogin && nieakt_60 < a.LastLogin    )// Neotr - zmiana
					{
						AddLabel( 200, 190, a.Banned ? RedHue : BlueAHue, a.Banned ? "Zablokowany" : "Nieaktywne ponad 30 dni" );//Neotr - Zmiana
					}
					else if ( nieakt_60 >= a.LastLogin && nieakt_90 < a.LastLogin )// Neotr - zmiana
					{
						AddLabel( 200, 190, a.Banned ? RedHue : BlueBHue, a.Banned ? "Zablokowany" : "Nieaktywne ponad 60 dni" );//Neotr - Zmiana
					}
					else if ( nieakt_90 >= a.LastLogin && nieakt_120 < a.LastLogin )// Neotr - zmiana
					{
						AddLabel( 200, 190, a.Banned ? RedHue : BlueCHue, a.Banned ? "Zablokowany" : "Nieaktywne ponad 90 dni" );//Neotr - Zmiana
					}
					else if ( nieakt_120 >= a.LastLogin && nieakt_240 < a.LastLogin )// Neotr - zmiana
					{
						AddLabel( 200, 190, a.Banned ? RedHue : BlueDHue, a.Banned ? "Zablokowany" : "Nieaktywne ponad 120 dni" );//Neotr - Zmiana
					}
					else if ( nieakt_240 >= a.LastLogin )// Neotr - zmiana
					{
						AddLabel( 200, 190, a.Banned ? RedHue : BlueDHue, a.Banned ? "Zablokowany" : "Nieaktywne ponad pol roku!" );//Neotr - Zmiana
					}
					else
					{
						AddLabel( 200, 190, a.Banned ? RedHue : GreenHue, a.Banned ? "Zablokowany" : "Aktywny" );//Neotr - Zmiana
					}
					...
					if ( a.Banned && a.GetBanTags( out banTime, out banDuration ) )
					{
						...
						{
							AddLabel( 290, 190, LabelHue, "(Na Zawsze)" );
						}
					...
					AddLabel(  20, 210, LabelHue, "Utworzone:" );
					AddLabel( 200, 210, LabelHue, a.Created.ToString() );

					AddLabel(  20, 230, LabelHue, "Ostatnie Polaczenie:" );
					AddLabel( 200, 230, LabelHue, a.LastLogin.ToString() ); 

					AddLabel(  20, 250, LabelHue, "Ilosc Postaci:" );
					AddLabel( 200, 250, LabelHue, charCount.ToString() );

					AddLabel(  20, 270, LabelHue, "Ilosc Komantarzy:" );
					AddLabel( 200, 270, LabelHue, a.Comments.Count.ToString() );

					AddLabel(  20, 290, LabelHue, "Ilosc Wpisow:" );
					AddLabel( 200, 290, LabelHue, a.Tags.Count.ToString() );

					AddButtonLabeled( 20, 320, GetButtonID( 5, 8 ), "Zmien Haslo" );
					AddButtonLabeled( 200, 320, GetButtonID( 5, 9 ), "Zmien Uprawnienia" );

					if ( !a.Banned )
						AddButtonLabeled( 20, 350, GetButtonID( 5, 10 ), "Blokada Dostepu" );
					else
						AddButtonLabeled( 20, 350, GetButtonID( 5, 11 ), "Odblokuj Dostep" );

					AddButtonLabeled( 200, 350, GetButtonID( 5, 25 ), "Usun Konto" );
				...
				case AdminGumpPage.AccountDetails_Access:
				{
					...
					AddHtml( 10, 125, 400, 20, Color( Center( "Uzytkownicy" ), LabelColor32 ), false, false );

					AddPageButton( 20, 150, GetButtonID( 5, 14 ), "Zobacz adresy", AdminGumpPage.AccountDetails_Access_ClientIPs );
					AddPageButton( 20, 170, GetButtonID( 5, 15 ), "Menadzer ograniczen", AdminGumpPage.AccountDetails_Access_Restrictions );
				...
				case AdminGumpPage.AccountDetails_Access_ClientIPs:
				{
					...
					AddHtml( 10, 195, 400, 20, Color( Center( "Adresy Uzytkownikow" ), LabelColor32 ), false, false );

					AddButtonLabeled( 200, 225, GetButtonID( 5, 16 ), "Zobacz wszystkie podzialy dostepu" );
					AddButtonLabeled( 200, 245, GetButtonID( 5, 17 ), "Zablokuj wszystkie podzialy dostepy" );
					AddButtonLabeled( 200, 265, GetButtonID( 5, 18 ), "Chron przed wszystkimi adresami" );
				...
				case AdminGumpPage.AccountDetails_Access_Restrictions:
				{
					...
					AddHtml( 10, 195, 400, 20, Color( Center( "Ograniczone Adresy" ), LabelColor32 ), false, false );

					AddTextField( 200, 225, 120, 20, 0 );

					AddButtonLabeled( 330, 225, GetButtonID( 5, 19 ), "Dodaj" );
				...
				case AdminGumpPage.AccountDetails_Characters:
				{
					...
					AddHtml( 10, 125, 400, 20, Color( Center( "Postacie" ), LabelColor32 ), false, false );

					AddLabelCropped(  12, 150, 120, 20, LabelHue, "Imie" );
					AddLabelCropped( 132, 150, 120, 20, LabelHue, "Uprawnienia" );
					...
					if ( index == 0 )
						AddLabel( 12, 170, LabelHue, "Te konto jest puste." );
				...
				case AdminGumpPage.AccountDetails_Comments:
				{
					...
					AddHtml( 10, 125, 400, 20, Color( Center( "Kometarz" ), LabelColor32 ), false, false );

					AddButtonLabeled( 20, 150, GetButtonID( 5, 4 ), "Dodaj Kometarz" );

					StringBuilder sb = new StringBuilder();

					if ( a.Comments.Count == 0 )
						sb.Append( "Nie ma jeszcze zadnego komentarza." );
				...
				case AdminGumpPage.AccountDetails_Tags:
				{
					...
					AddHtml( 10, 125, 400, 20, Color( Center( "Opis" ), LabelColor32 ), false, false );

					AddButtonLabeled( 20, 150, GetButtonID( 5, 5 ), "Dodaj Opis" );

					StringBuilder sb = new StringBuilder();

					if ( a.Tags.Count == 0 )
						sb.Append( "Nie ma jeszcze zadnego opisu." );
				...
				case AdminGumpPage.Firewall:
				{
					...
					if ( m_List.Count == 0 )
						AddLabel( 12, 140, LabelHue, "Lista zabezpieczen jest pusta." );
				...
				case AdminGumpPage.FirewallInfo:
				{
					...
					AddButtonLabeled( 20, 150, GetButtonID( 6, 3 ), "Usun" );
					...
					for ( int i = 0, index = (listPage * 9); i < 9 && index >= 0 && index < m_List.Count; ++i, ++index )
					{
						...
						if ( online )
							...
							AddLabelCropped( 252, offset, 120, 20, RedHue, "Zablokowany" );
						else
							AddLabelCropped( 252, offset, 120, 20, RedHue, "Offline" );
		...
		public void AddClientHeader()
		{
			...
			AddButtonLabeled( 200, 50, GetButtonID( 4, 0 ), "Szukaj Imienia" );
			AddButtonLabeled( 200, 80, GetButtonID( 4, 1 ), "Szukaj Adres IP" );
		}
		...
		public void AddAccountHeader()
		{
			...
			AddLabel( 200, 20, LabelHue, "Login:" );
			AddTextField( 250, 20, 150, 20, 0 );

			AddLabel( 200, 50, LabelHue, "Haslo:" );
			AddTextField( 250, 50, 150, 20, 1 );

			AddButtonLabeled( 200, 80, GetButtonID( 5, 6 ), "Dodaj" );
			AddButtonLabeled( 290, 80, GetButtonID( 5, 7 ), "Szukaj" );

			AddButton( 384, 84, 0x15E1, 0x15E5, 0, GumpButtonType.Page, 2 );

			AddPage( 2 );

			AddButtonLabeled( 200, 20, GetButtonID( 5, 31 ), "Zobacz Wszystkie: Nieaktywne" );
			AddButtonLabeled( 200, 40, GetButtonID( 5, 32 ), "Zobacz Wszystkie: Zablokowane" );
			AddButtonLabeled( 200, 60, GetButtonID( 5, 26 ), "Zobacz Wszystkie: Spisy" );
			AddButtonLabeled( 200, 80, GetButtonID( 5, 30 ), "Zobacz Wszystkie: Puste" );
		...
		{
			AddTextField( 200, 20, 200, 20, 0 );
			AddButtonLabeled( 320, 50, GetButtonID( 6, 0 ), "Szukaj" );
			AddButtonLabeled( 200, 50, GetButtonID( 6, 1 ), "Dodaj (Wyjscia)" );
			AddButtonLabeled( 200, 80, GetButtonID( 6, 2 ), "Dodaj (Wybierz)" );
		}
			...
			switch ( type )
			{
				...
				case 3:
				{
					...
					switch ( index )
					{
						...
						case 201: Down.Down_OnCommand( new CommandEventArgs( sender.Mobile, "Down", "", new string[0] ) );break;
						case 202: Downb.Downb_OnCommand( new CommandEventArgs( sender.Mobile, "DownB", "", new string[0] ) );break;
						case 203: AutoRestart.Restart_OnCommand( new CommandEventArgs( sender.Mobile, "Restart", "", new string[0] ) );break;
						case 204: Restartb.Restartb_OnCommand( new CommandEventArgs( sender.Mobile, "RestartB", "", new string[0] ) );break;
						case 205: DownplanAlfa.DownPlanowanyAlfa_OnCommand( new CommandEventArgs( sender.Mobile, "Down120", "", new string[0] ) );break;
						case 206: ResplanAlfa.RestartPlanowanyAlfa_OnCommand( new CommandEventArgs( sender.Mobile, "Res120", "", new string[0] ) );break;
						case 207: QuickRestart.QuickRestart_OnCommand( new CommandEventArgs( sender.Mobile, "QuickRestart", "", new string[0] ) );break;
						//case 208:
						...
						case 211:
						{
							...
							{
								notice = "Musisz wpisac tresc wiadomosci!.";
							}
							else
							{
								notice = "Twoja wiadomosc zostala wyslana.";
					...
					switch ( index )
					{
						...
						case 1:
						{
							...
							if ( results.Count == 1 )
							{
								...
								if ( state is Mobile )
									from.SendGump( new AdminGump( from, AdminGumpPage.ClientInfo, 0, null, "Znaleziono tylko jedno.", state ) );
								else if ( state is Account )
									from.SendGump( new AdminGump( from, AdminGumpPage.AccountDetails_Information, 0, null, "Znaleziono tylko jedno.", state ) );
								else
									from.SendGump( new AdminGump( from, AdminGumpPage.Clients, 0, results, "Znaleziono tylko jedno.", null ) );
							}
							else
							{
								from.SendGump( new AdminGump( from, AdminGumpPage.Clients, 0, results, notice == null ? (results.Count == 0 ? "Nie znaleziono zadnego." : null) : notice, null ) );
							}
				...
				case 5:
				{
					switch ( index )
					{
						...
						case 6:
						{
							...
							{
								notice = "Musisz wpisac login uzytkowinika aby utworzyc nowe konto!";
							}
							else if ( pw == null || pw.Length == 0 )
							{
								notice = "Musisz wpisac takze haslo aby utworzyc nowe konto!";
							}
							else
							{
								...
								if ( account != null )
								{
									notice = "Konto o podanym loginie juz istnieje!";
								}
								else
								{
									dispAccount = new Account( un, pw );
									notice = String.Format( "{0} : Konto utworzone.", un );
									CommandLogging.WriteLine( from, "{0} {1} utwozyl nowe konto: {2}", from.AccessLevel, CommandLogging.Format( from ), un );
								}
							}
						...
						case 12:
						{
							...
							{
								notice = "Musisz podac nowe haslo.";
							}
							else if ( confirm != password )
							{
								notice = "Musisz podac dwa razy takie samo haslo.";
							}
							else
							{
								notice = "Haslo zostalo zmienione.";
						...
						case 31: // View all inactive accounts
						{
							...
							DateTime minTime = DateTime.Now - TimeSpan.FromDays( Config.NoActiveAccount );// 30 Neotr - zmiana
				...
				case 7:
				{
					...
					switch ( index )
					{
						...
						/*case 15://Wieznienie
						{
							CommandLogging.WriteLine( from, "{0} {1} wiezienie {2}", from.AccessLevel, CommandLogging.Format( from ), CommandLogging.Format( m ) );
							Server.DE.Jail.JailCommand.JailThem((Server.Mobiles.PlayerMobile)m, Server.DE.Jail.JailCommand.JailOption.None);
							notice = "Postac zostala wtracona do wiezienia.";
							break;
						}
						case 16://Uwolnij
						{
							CommandLogging.WriteLine( from, "{0} {1} uwolnienie z wiezienia {2}", from.AccessLevel, CommandLogging.Format( from ), CommandLogging.Format( m ) );
							Server.DE.Jail.JailCommand.FreeThem((Server.Mobiles.PlayerMobile)m);
							notice = "Postac zostala uwoniona z wiezienia.";
							break;
						}*/
					}
