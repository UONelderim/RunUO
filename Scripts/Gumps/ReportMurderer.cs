...
namespace Server.Gumps
{
	public class ReportMurdererGump : Gump
	{
		...
		public static void EventSink_PlayerDeath( PlayerDeathEventArgs e )
		{
			...
			/* pozowlmy zlodziejom zglaszac morderstwa:
			...
			switch ( info.ButtonID )
			{
				...
				{            
					...
					if ( killer != null && !killer.Deleted )
					{
                        ...
                        {
                            // 22.09.2012 :: zombie :: zliczanie morderstw poszczegolnych ras
                            //if ( m_Victum is PlayerMobile )
                            //{
                            //    Race victumRace = ((PlayerMobile)m_Victum).Race;
                            //    ((PlayerMobile)killer).RacialKills[ victumRace.RaceID ]++;
                            //}                           
                            // zombie
