...
{
	[CorpseName( "pozostalosci terroru" )]
	public class AbysmalHorror : BaseCreature
	{
        public override void AddWeaponAbilities()
        {
            WeaponAbilities.Add( WeaponAbility.MortalStrike, 0.2 );
            WeaponAbilities.Add( WeaponAbility.WhirlwindAttack, 0.2 );
        }

		public override bool IgnoreYoungProtection { get { return Core.ML; } }

		[Constructable]
		public AbysmalHorror() : base( AIType.AI_BattleMage, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
