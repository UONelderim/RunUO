...
{
	[CorpseName( "zwloki rycerza mroku" )]
	public class ShadowKnight : BaseCreature
	{
        public override void AddWeaponAbilities()
        {
            WeaponAbilities.Add( WeaponAbility.ConcussionBlow, 0.2 );
            WeaponAbilities.Add( WeaponAbility.CrushingBlow, 0.2 );
        }

		public override bool IgnoreYoungProtection { get { return Core.ML; } }

		[Constructable]
		public ShadowKnight() : base( AIType.AI_BattleMage, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
