...
{
	[CorpseName( "zwloki wscieklego niedziwiedza gryzzli" )]
	[TypeAlias( "Server.Mobiles.Grizzlybear" )]
	public class RagingGrizzlyBear : BaseCreature
	{
		[Constructable]
		public RagingGrizzlyBear() : base( AIType.AI_Animal, FightMode.Aggressor, 12, 1, 0.2, 0.4 )
		{
			Name = "wsciekly niedzwiedz gryzzli";
			Body = 212;
			BaseSoundID = 0xA3;
