...
namespace Server.Mobiles
{
	...
	public class PestilentBandage : BaseCreature
	{
		...
		[Constructable]
		public PestilentBandage() : base( AIType.AI_Melee, FightMode.Closest, 12, 1, 0.2, 0.4 ) // NEED TO CHECK
		{
			Name = "mumia zarazy";
			Body = 154;
			Hue = 0x515; 
			...
			PackItem( new Bandage( 10 ) );			// How many?
