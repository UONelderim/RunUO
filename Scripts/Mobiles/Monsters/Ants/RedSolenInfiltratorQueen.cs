...
{
	[CorpseName( "zwloki szpiega czerwonych mrowek" )] // TODO: Corpse name?
	public class RedSolenInfiltratorQueen : BaseCreature
	{
		[Constructable]
		public RedSolenInfiltratorQueen() : base( AIType.AI_Melee, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
			...
			PackItem( new ZoogiFungus( ( 0.05 < Utility.RandomDouble() )? 3 : 5 ) );
		}
