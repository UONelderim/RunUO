...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public SavageShaman() : base( AIType.AI_BattleMage, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
		...
		{
			if ( to is Dragon || to is WhiteWyrm || to is SwampDragon || to is Drake || to is Nightmare || to is Hiryu || to is LesserHiryu || to is CommonDaemon )
				damage *= 3;
		}
