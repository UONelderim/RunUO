...
{
	[CorpseName( "zwloki koscianego smoka" )]
	public class SkeletalDragon : BaseCreature
	{
		[Constructable]
		public SkeletalDragon () : base( AIType.AI_BattleMage, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
			Name = "kosciany smok";
			Body = 104;
			BaseSoundID = 0x488;
		...
		{
            //if( !IsBonded && !corpse.Carved && !IsQuestMonster )
            //{
		...
		public override int Meat{ get{ return 2; } } // where's it hiding these? :)
