...
{
	[CorpseName( "zwloki wojownika yomotsu" )]
	public class YomotsuWarrior : BaseCreature
	{
        public override void AddWeaponAbilities()
        {
            WeaponAbilities.Add( WeaponAbility.DoubleStrike, 0.4 );
        }

		[Constructable]
		public YomotsuWarrior() : base( AIType.AI_Melee, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
