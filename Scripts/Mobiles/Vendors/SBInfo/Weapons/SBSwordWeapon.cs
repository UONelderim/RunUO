...
namespace Server.Mobiles
{
	public class SBSwordWeapon: SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			{
				Add( new GenericBuyInfo( typeof( Cutlass ), 27, 20, 0x1441, 0 ) );
				...
				if ( Core.AOS )
				{
					...
					Add( new GenericBuyInfo( typeof( CrescentBlade ), 46, 20, 0x26C1, 0 ) );
					Add( new GenericBuyInfo( typeof( DoubleBladedStaff ), 53, 20, 0x26BF, 0 ) );
					Add( new GenericBuyInfo( typeof( Lance ), 66, 20, 0x26C0, 0 ) );
					Add( new GenericBuyInfo( typeof( Pike ), 46, 20, 0x26BE, 0 ) );
					Add( new GenericBuyInfo( typeof( Scythe ), 46, 20, 0x26BA, 0 ) );
				}
