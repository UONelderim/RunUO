// 05.04.24 :: Evantis :: usuniecie ze sprzedazy bagball
// 05.05.17 :: troyan :: naprawa buga z cenami u krawca
// 05.07.01 :: Eleshar :: dodano skrzynke na nasiona
//2005.09.26 :: eth :: gildie
// 06.01.16 :: troyan :: Religia v18
// 06.04.01 :: troyan :: usuniecie cash buga frakcyjnego
...
namespace Server.Mobiles
{
	public class SBProvisioner : SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			{
/*				Add( new GenericBuyInfo( typeof( SmallMasterIdol ), 14, 60, 0x1851, 2219 ) );
				Add( new GenericBuyInfo( typeof( MediumMasterIdol ), 77, 15, 0x1851, 2401 ) ); 
				
				Add( new GenericBuyInfo( typeof( SmallMotherIdol ), 14, 60, 0x139B, 1372 ) );
				Add( new GenericBuyInfo( typeof( MediumMotherIdol ), 77, 15, 0x139B, 1370 ) ); 
				
				Add( new GenericBuyInfo( typeof( SmallDeathIdol ), 14, 60, 0x2646, 2376 ) );
				Add( new GenericBuyInfo( typeof( MediumDeathIdol ), 77, 15, 0x2646, 2412 ) ); 
