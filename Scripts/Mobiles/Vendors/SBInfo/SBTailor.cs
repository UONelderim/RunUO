...
namespace Server.Mobiles
{
    ...
    public class SBTailorAddons : SBInfo
    {
        private ArrayList m_BuyInfo = new InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new InternalSellInfo();

        public SBTailorAddons()
        {
        }
    ...
    // To samo co w SBTailor, ale bez sprzedawania do NPC
    public class SBTailorBuy : SBInfo
    {
        private ArrayList m_BuyInfo = new SBTailor.InternalBuyInfo();
