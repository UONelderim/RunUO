...
{ 
	...
	{ 
		...
		{ 
			...
			{ 	
				//Add( new GenericBuyInfo( typeof( IronIngot ), 5, 0, 0x1BF2, 0 ) );
    ...
    public class SBBlacksmithAddons : SBInfo
    {
        private ArrayList m_BuyInfo = new InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new InternalSellInfo();

        public SBBlacksmithAddons()
        {
        }
    ...
    // To samo co w SBBlacksmith, ale bez sprzedawania do NPC
    public class SBBlacksmithBuy : SBInfo
    {
        private ArrayList m_BuyInfo = new SBBlacksmith.InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new GenericSellInfo(); // umyslnie puste

        public SBBlacksmithBuy()
        {
        }
