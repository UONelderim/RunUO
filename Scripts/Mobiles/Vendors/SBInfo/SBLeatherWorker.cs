...
{ 
    ...
    public class SBLeatherWorkerAddons : SBInfo
    {
        private ArrayList m_BuyInfo = new InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new InternalSellInfo();

        public SBLeatherWorkerAddons()
        {
        }
    ...
    // To samo co w SBLeatherWorker, ale bez sprzedawania do NPC
    public class SBLeatherWorkerBuy : SBInfo
    {
        private ArrayList m_BuyInfo = new SBLeatherWorker.InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new GenericSellInfo();  // umyslnie puste

        public SBLeatherWorkerBuy()
        {
        }
