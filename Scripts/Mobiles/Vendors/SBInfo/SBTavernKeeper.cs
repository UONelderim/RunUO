	...
	public class SBTavernKeeper : SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( ApplePie ), 7, 5, 0x1041, 0 ) ); //OSI just has Pie, not Apple/Fruit/Meat
				...
				if ( Multis.BaseHouse.NewVendorSystem )
					Add( new GenericBuyInfo( "1062332", typeof( VendorRentalContract ), 2000, 5, 0x14F0, 0x672 ) );
