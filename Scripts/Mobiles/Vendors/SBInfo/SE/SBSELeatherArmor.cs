...
namespace Server.Mobiles
{
	public class SBSELeatherArmor: SBInfo
	{
		...
		public class InternalBuyInfo : ArrayList
		{
			...
			{
				Add( new GenericBuyInfo( typeof( LeatherJingasa ), 19, 20, 0x2776, 0 ) );
				...
				Add( new GenericBuyInfo( typeof( LeatherHaidate), 57, 20, 0x278A, 0 ) );
				Add( new GenericBuyInfo( typeof( LeatherNinjaPants ), 61, 20, 0x2791, 0 ) );
				Add( new GenericBuyInfo( typeof( LeatherNinjaJacket ), 61, 20, 0x2793, 0 ) );
