...
namespace Server.Mobiles
{
    ...
    // To samo co w SBSECarpenterBuy, ale bez sprzedawania do NPC
    public class SBSECarpenterBuy : SBInfo
    {
        private ArrayList m_BuyInfo = new SBSECarpenter.InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new GenericSellInfo();  // umyslnie puste

        public SBSECarpenterBuy()
        {
        }
