...
{ 
    ...
    // To samo co w SBWeaponSmith, ale bez sprzedawania do NPC
    public class SBWeaponSmithBuy : SBInfo
    {
        private ArrayList m_BuyInfo = new SBWeaponSmith.InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new GenericSellInfo();  // umyslnie puste

        public SBWeaponSmithBuy()
        {
        }
