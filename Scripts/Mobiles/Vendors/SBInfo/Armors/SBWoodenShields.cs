...
namespace Server.Mobiles
{
    ...
    // To samo co w SBWoodenShields, ale bez sprzedawania do NPC
    public class SBWoodenShieldsBuy : SBInfo
    {
        private ArrayList m_BuyInfo = new SBWoodenShields.InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new GenericSellInfo();  // umyslnie puste

        public SBWoodenShieldsBuy()
        {
        }
