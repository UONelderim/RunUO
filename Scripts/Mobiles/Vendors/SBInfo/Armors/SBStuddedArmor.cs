...
namespace Server.Mobiles
{
    ...
    // To samo co w SBStuddedArmor, ale bez sprzedawania do NPC
    public class SBStuddedArmorBuy : SBInfo
    {
        private ArrayList m_BuyInfo = new SBStuddedArmor.InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new GenericSellInfo();

        public SBStuddedArmorBuy()
        {
        }
