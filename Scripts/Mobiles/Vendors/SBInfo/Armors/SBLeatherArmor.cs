...
namespace Server.Mobiles
{
    ...
    // To samo co w SBLeatherArmor, ale bez sprzedawania do NPC
    public class SBLeatherArmorBuy : SBInfo
    {
        private ArrayList m_BuyInfo = new SBLeatherArmor.InternalBuyInfo();
        private IShopSellInfo m_SellInfo = new GenericSellInfo();  // umyslnie puste

        public SBLeatherArmorBuy()
        {
        }
