...
{ 
	...
	{ 
		...
		{ 
			...
			{ 
				Add( new GenericBuyInfo( typeof( BreadLoaf ), 5, 50, 0x103B, 0 ) );
				Add( new GenericBuyInfo( typeof( BreadLoaf ), 5, 50, 0x103C, 0 ) );
				Add( new GenericBuyInfo( typeof( ApplePie ), 7, 50, 0x1041, 0 ) ); //OSI just has Pie, not Apple/Fruit/Meat
				Add( new GenericBuyInfo( typeof( Cake ), 13, 50, 0x9E9, 0 ) );
				Add( new GenericBuyInfo( typeof( Muffins ), 3, 50, 0x9EA, 0 ) );

				Add( new GenericBuyInfo( typeof( CheeseWheel ), 4, 50, 0x97E, 0 ) );
				Add( new GenericBuyInfo( typeof( CookedBird ), 8, 50, 0x9B7, 0 ) );
				Add( new GenericBuyInfo( typeof( LambLeg ), 8, 50, 0x160A, 0 ) );
				Add( new GenericBuyInfo( typeof( ChickenLeg ), 5, 50, 0x1608, 0 ) );
