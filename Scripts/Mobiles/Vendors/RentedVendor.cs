// 05.10.08 :: troyan :: stanowiska kupieckie
// 05.10.10 :: troyan :: tytul
// 05.10.11 :: troyan :: naprawa bledu ze znikaniem kontraktu po zniknieciu vendora przy braku kasy na oplate
...
namespace Server.Mobiles
{
	...
	public class RentedVendor : PlayerVendor
	{
		...
		protected Timer m_RentalExpireTimer;
		...
		public virtual bool IsLandlord( Mobile m )
		{
		...
		protected class RentalExpireTimer : Timer
		{
			private RentedVendor m_Vendor;
	...
	public class PublicVendor : RentedVendor
	{
		...
		public string EditableExpireTime
		{
			...
			set 
			{
				try
				{
					...
					m_RentalExpireTimer.Stop();
					TimeSpan delay = m_RentalExpireTime - DateTime.Now;
					m_RentalExpireTimer = new RentalExpireTimer( this as RentedVendor, delay > TimeSpan.Zero ? delay : TimeSpan.Zero );
					m_RentalExpireTimer.Start();
				}
				catch
				{}
		...
		public override bool IsLandlord( Mobile m )
		{
