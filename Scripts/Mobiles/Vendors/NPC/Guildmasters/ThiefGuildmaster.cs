...
namespace Server.Mobiles
{
	public class ThiefGuildmaster : BaseGuildmaster
	{
		...
		[Constructable]
		public ThiefGuildmaster() : base( "zlodziei" )
		{
			SetSkill( SkillName.DetectHidden, 75.0, 77.0 );
		...
		public override bool CheckCustomReqs( PlayerMobile pm )
		{
            ...
            {
                SayTo(pm, 1063883); // Miasto nie oplacilo moich uslug. Nieczynne.
            }
			else if ( pm.Young )
			{
		...
		public override bool OnGoldGiven( Mobile from, Gold dropped )
		{
			if ( from is PlayerMobile && dropped.Amount == 700 )
			{
				...
				{
					from.AddToBackpack( new DisguiseKitNelderim() );
