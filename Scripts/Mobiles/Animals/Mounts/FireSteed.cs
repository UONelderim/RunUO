...
namespace Server.Mobiles
{
	...
	{
		[Constructable]
		public FireSteed() : this( "ognisty rumak" )
		{
		}
public override void AddWeaponAbilities()
		...
		[Constructable]
		public FireSteed( string name ) : base( name, 0xBE, 0x3E9E, AIType.AI_Melee, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0xA8;
		...
		public override void OnCarve(Mobile from, Corpse corpse, Item with)
		{
            if (!IsBonded && !corpse.Carved && !IsChampionSpawn)
            {
                if (Utility.RandomDouble() < 0.20)
                    corpse.DropItem(new BowstringFiresteed());
                if (Utility.RandomDouble() < 0.20)
		...
		public override void GenerateLoot()
		{
			...
			PackItem( new Ruby( Utility.RandomMinMax( 5, 10 ) ) );
		}
