...
namespace Server.Mobiles
{
    public class BaseEscortable : BaseCreature
    {
        ...
        // 15.08.2012 :: zombie
        public override bool CanBeTeleported { get { return false; } }
        // zombie
        ...
        // 15.08.2012 :: zombie
        // TODO :: dostosowac do mapy Nelderim
        ...
        // 15.08.2012 :: zombie :: tlumaczenie (przeniesione)
        public virtual bool SayDestinationTo( Mobile m )
        {
            ...
            if ( escorter == null )
            {
                Say( "Cel mej podrozy, to {0}. Dasz mi ochrone?", dest.Name );
                return true;
            }
            else if ( escorter == m )
            {
                Say( "Prowadz! Kierunek {0} Tam otrzymasz zaplate.", dest.Name );
                return true;
            }
        ...
        public virtual bool AcceptEscorter( Mobile m )
        {
            ...
            {
                Say( "Widze, ze juz kogos eskortujesz." );
                return false;
            }
            else if ( m is PlayerMobile && (((PlayerMobile)m).LastEscortTime + m_EscortDelay) >= DateTime.Now )
            {
                ...
                Say( "Odpocznij {0} {1} zanim udasz sie w kolejna podroz.", minutes / 2, minutes < 2 ? "klepsydre" : "klepsydr" );
                return false;
            }
        ...
        public override void OnSpeech( SpeechEventArgs e )
        {
            ...
            {
                if ( Regex.IsMatch( e.Speech, "cel", RegexOptions.IgnoreCase ) && Regex.IsMatch( e.Speech, "podroz", RegexOptions.IgnoreCase ) ) // *destination*
                    e.Handled = SayDestinationTo( e.Mobile );
                else if ( Regex.IsMatch( e.Speech, "cie", RegexOptions.IgnoreCase ) && Regex.IsMatch( e.Speech, "odprowadz", RegexOptions.IgnoreCase )) // *i will take thee*
    ...
    public class EscortDestinationInfo
    {
        ...
        public static void LoadTable()
        {
            ...
            foreach ( Region r in list )
            {
                ...
                if ( r is Regions.DungeonRegion || r is Regions.CityRegion )
