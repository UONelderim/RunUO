...
namespace Server.Commands
{
	public class CommandLogging
	{
		...
		public static void Initialize()
		{
			...
			try
			{
				m_Output = new StreamWriter( Path.Combine( directory, String.Format( "Komendy {0}.log", GetTimeStamp() ) ), true );
		...
		public static string GetLabelOfCreator( Mobile from )
		{
