...
namespace Server.Regions
{
	public class HouseRegion : BaseRegion
	{
		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			...
			if ( Regex.IsMatch( e.Speech, "wyrzucam cie", RegexOptions.IgnoreCase ) || Regex.IsMatch( e.Speech, "wyrzucam cie", RegexOptions.IgnoreCase ) ) // remove thyself
			{
				if ( isFriend )
				{
			...
			else if ( Regex.IsMatch( e.Speech, "zakazuje ci wstepu", RegexOptions.IgnoreCase ) || Regex.IsMatch( e.Speech, "zakazuje ci wstepu", RegexOptions.IgnoreCase ) ) // I ban thee
			{
				if ( !isFriend )
				{
					from.SendLocalizedMessage( 502094 ); // You must be in your house to do this.
			...
			else if ( Regex.IsMatch( e.Speech, "chce to zablokowac", RegexOptions.IgnoreCase ) || Regex.IsMatch( e.Speech, "chce to zablokowac", RegexOptions.IgnoreCase ) ) // I wish to lock this down
			{
				if ( isCoOwner )
				{
			...
			else if ( Regex.IsMatch( e.Speech, "chce to odblokowac", RegexOptions.IgnoreCase ) || Regex.IsMatch( e.Speech, "chce to odblokowac", RegexOptions.IgnoreCase ) ) // I wish to release this
			{
				if ( isCoOwner )
				{
			...
			else if ( Regex.IsMatch( e.Speech, "chce to zabezpieczyc", RegexOptions.IgnoreCase ) || Regex.IsMatch( e.Speech, "chce to zabezpieczyc", RegexOptions.IgnoreCase ) ) // I wish to secure this
			{
				if (isCoOwner)
				{
			...
			else if ( Regex.IsMatch( e.Speech, "chce to odbezpieczyc", RegexOptions.IgnoreCase ) || Regex.IsMatch( e.Speech, "chce to odbezpieczyc", RegexOptions.IgnoreCase ) ) // I wish to unsecure this
			{
				if (isCoOwner)
				{
			...
			else if ( Regex.IsMatch( e.Speech, "chce postawic bezpieczny pojemnik", RegexOptions.IgnoreCase ) || Regex.IsMatch( e.Speech, "chce postawic bezpieczny pojemnik", RegexOptions.IgnoreCase ) ) // I wish to place a strong box
			{
				if ( isOwner )
				{
			...
			else if ( Regex.IsMatch( e.Speech, "chce postawic kosz", RegexOptions.IgnoreCase ) || Regex.IsMatch( e.Speech, "chce postawic kosz", RegexOptions.IgnoreCase ) )
			{
				if ( isCoOwner )
				{
