	...
	public class SHTeleporter : BaseAddon
	{
		...
		public class SHTeleporterCreator
		{
			...
			public int CreateSHTeleporters()
			{
				...
				//Center->SW->Norstyg
				AddSHTCouple( true, 5845, 2767, 0, true, 5761, 2767, 0 );
				AddSHTCouple( true, 5772, 2790, 0, true, 5718, 2791, 0 );
				AddSHTCouple( true, 5716, 2855, 0, true, 1888, 2906, 0 );
				//Center->NW->Darkelot
				AddSHTCouple( true, 5808, 2734, 0, true, 5719, 2738, 0 );
				AddSHTCouple( true, 5788, 2732, 0, true, 5817, 2633, 0 );
				AddSHTCouple( true, 5716, 2630, 0, true, 2703, 1236, 5 );
				//Center->NE->Joramit
				AddSHTCouple( true, 5832, 2705, 0, true, 5912, 2686, 0 );
				AddSHTCouple( true, 5932, 2706, 0, true, 5957, 2716, 0 );
				AddSHTCouple( true, 5978, 2633, 0, true, 4588, 1220, 10 );
				//Center->SE->Rewian
				AddSHTCouple( true, 5869, 2743, 0, true, 5936, 2728, 0 );
				AddSHTCouple( true, 5873, 2850, 0, true, 5973, 2731, 0 );
				AddSHTCouple( true, 5979, 2858, 0, true, 3726, 2746, 10 );
				//5th-hole
				//AddSHTCouple( true, 5801, 2698, 0, false, 4616, 1341, 0 );
				//tele1 = AddSHT( Map.Felucca, true, 5801, 2698, 0 );
				//tele2 = AddSHT( Map.Felucca, false, 4616, 1341, -5 );
				//Link( tele1, tele2 );
				//AddSHT( Map.Felucca, false, 4616, 1341, -5 ).ChangeDest( tele2 );								
				/*
