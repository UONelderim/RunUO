...
namespace Server.Items
{
	...
	public class DeathRobe : Robe, IScissorable
	{
        ...
        private bool TurnIntoBandages(Mobile from)
        {
            ...
            {
                if ( from.AddToBackpack( new Bandage( 2 ) ) )
                {
                    this.Consume();
        ...
        // zombie - 20-06-2012 - 2x click na deathrobe daje 2 bandaze
        public override void OnDoubleClick(Mobile from)
        {
            TurnIntoBandages(from);
        }
        // zombie
