...
namespace Server.Items
{
	...
	public abstract class BaseInstrument : Item, ICraftable, ISlayer, IIdentifiable
	{
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			m_IdentifiedLevel = ItemIdentification.PropertiesCount(null, null, m_Slayer, m_Slayer2, null, null, null, m_ReplenishesCharges?1:0 );
