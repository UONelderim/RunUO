...
namespace Server.Items
{
	public class MessageInABottle : Item
	{
		...
		{
			get{ return m_Level; }
			set{ m_Level = Math.Max( 1, Math.Min( value, 5 ) ); }
		}

		[Constructable]
		public MessageInABottle() : this( Map.Felucca )	// 18.01.2013 - mortuus: mapa Nelderim jest zbudowana na Felucca.   /*Map.Trammel*/
		{
		}
