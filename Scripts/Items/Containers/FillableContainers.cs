...
namespace Server.Items
{
	...
	public class FillableContent
	{
		...
		*/
		...
		public static FillableContent LeatherWorker = new FillableContent(
			2,
			new Type[]
			{
        ...
        */
		...
		public static FillableContent Acquire( Point3D loc, Map map )
		{
			...
			{
				if ( nearest != null && mob.GetDistanceToSqrt( loc ) > nearest.GetDistanceToSqrt( loc ) && !(mob is VarietyDealer) )
					continue;
