...
{
	public class BaseQuiver : Container, ICraftable, IWearableDurability, IHitPoints
	{
		...
		public virtual int InitMinHits { get { return 90; } }
		public virtual int InitMaxHits { get { return 110; } }
			...
			if (Config.ItemDurabilityLostChance > Utility.Random(100)) {
				...
				if (wear > 0 && MaxHitPoints > 0) {
					...
					if(HitPoints < 5 && Parent is Mobile) {
						((Mobile)Parent).LocalOverheadMessage(MessageType.Regular, 0x3B2, 1061188); // Twoj kolczan sie rozpada!
					}
		...
		public override void Deserialize(GenericReader reader) {
			...
			switch (version) {
				case 1: {
						...
						HitPoints = reader.ReadEncodedInt();
