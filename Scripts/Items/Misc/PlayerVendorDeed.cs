...
namespace Server.Items
{
	public class ContractOfEmployment : Item
	{
		...
		public static int Price { get { return 10000; } } // koszt postawienia vendora ze "zwoju z plecaka"
				...
				else
				{
					...
					else
					{
						if ( Banker.Withdraw( from, Price ) )
						{
							...
							from.SendMessage("Z twojego banku pobrano {0} zlota.", Price);
						...
						{
							from.SendLocalizedMessage(502677); // Przykro mi, nie masz tyle zlota w skrzyni bankowej.
						}
					}
				}
			}
