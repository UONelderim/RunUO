...
namespace Server.Items
{
	...
	public abstract class BaseAxe : BaseMeleeWeapon, IUsesRemaining
	{
		...
		public override void UnscaleDurability()
		{
			...
			// 27.01.2013 mortuus - zmiana zaleznosci Uses od Quality na taka, jak w narzedziach rzemieslniczych:
		...
		{
			// 27.01.2013 mortuus - Domyslnie topory i kilofy beda niskiej jakosci. Zmiana ilosci Uses.
			Quality = WeaponQuality.Low;
			m_UsesRemaining = Utility.RandomMinMax( 24, 26 );
		}
