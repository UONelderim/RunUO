...
namespace Server.Items
{
	public class BallOfSummoning : Item, TranslocationItem
	{
		...
		public string TranslocationItemName{ get{ return "Kula Przywołania"; } }
		...
		public void CastSummonPet( Mobile from )
		{
			...
			else if ( from.Map == Map.Ilshenar || from.Region.IsPartOf( typeof( DungeonRegion ) ) || from.Region.IsPartOf( typeof( JailRegion ) ) )
			{
