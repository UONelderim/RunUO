...
namespace Server.Items
{
	...
	public class PristineDreadHorn : Item
	{
		...
		public PristineDreadHorn()
			: base( 0x315A )
		{
			Name = "Nienaruszona Głowa Spaczonego";
		}
