...
namespace Server.Items
{
	public enum CraftResource
	{
        ...
        BowstringHorned,
        BowstringBarbed
        // !!! Dodajac nowe cieciwy pamietaj, aby uaktualnic wartosc w GetType() na nazwe ostatniej cieciwy.
	}
	...
	public class CraftAttributeInfo
	{
        ...
        public static readonly CraftAttributeInfo BowstringLeather, BowstringCannabis, BowstringSilk, BowstringFiresteed, BowstringUnicorn, BowstringNightmare, BowstringKirin, BowstringGut, BowstringSpined, BowstringHorned, BowstringBarbed;
		...
		static CraftAttributeInfo()
		{
            ...
            // zombie - 17-06-2012
            CraftAttributeInfo oak = OakWood = new CraftAttributeInfo();	// zywiczne
            ...
            heart.ArmorDurability = 45;
            heart.WeaponDamageIncrease = 5;
            heart.WeaponPoisonDamage = 40;
			heart.RunicMinAttributes = 3;
			heart.RunicMaxAttributes = 4;
			heart.RunicMinIntensity = 55;
			heart.RunicMaxIntensity = 100;

			CraftAttributeInfo blood = Bloodwood = new CraftAttributeInfo();	// Opalone
            ...
            blood.ArmorDurability = 60;
            blood.WeaponDamageIncrease = 10;
            blood.WeaponFireDamage = 40;
			blood.RunicMinAttributes = 4;
			blood.RunicMaxAttributes = 4;
			blood.RunicMinIntensity = 60;
			blood.RunicMaxIntensity = 100;

			CraftAttributeInfo frost = Frostwood = new CraftAttributeInfo();	// Zmarzniete
            ...
            frost.ArmorDurability = 75;
            frost.WeaponDamageIncrease = 10;
            frost.WeaponColdDamage = 40;
			frost.RunicMinAttributes = 4;
			frost.RunicMaxAttributes = 5;
			frost.RunicMinIntensity = 70;
			frost.RunicMaxIntensity = 100;
			// zombie

			CraftAttributeInfo bowstrLeather = BowstringLeather  = new CraftAttributeInfo();	// Cieciwa Skorzana
            bowstrLeather.WeaponDamageIncrease = 0;

            CraftAttributeInfo bowstrSpined = BowstringSpined = new CraftAttributeInfo();	// Cieciwa z niebieskiej skory
            bowstrSpined.WeaponDamageIncrease = 0;

            CraftAttributeInfo bowstrHorned = BowstringHorned = new CraftAttributeInfo();	// Cieciwa z czerwonej skory
            bowstrHorned.WeaponDamageIncrease = 0;

            CraftAttributeInfo bowstrBarbed = BowstringBarbed = new CraftAttributeInfo();	// Cieciwa z zielonej skory
            bowstrBarbed.WeaponDamageIncrease = 0;

			CraftAttributeInfo bowstrGut = BowstringGut = new CraftAttributeInfo(); // Cieciwa Jelitowa
			bowstrGut.WeaponDamageIncrease = 2;

			CraftAttributeInfo bowstrCannabis = BowstringCannabis  = new CraftAttributeInfo();	// Cieciwa Konopna
            bowstrCannabis.WeaponDamageIncrease = 3;

            CraftAttributeInfo bowstrSilk = BowstringSilk  = new CraftAttributeInfo();	// Cieciwa Jedwabna
            bowstrSilk.WeaponDamageIncrease = 5;

            CraftAttributeInfo bowstrFiresteed = BowstringFiresteed  = new CraftAttributeInfo();	// Cieciwa z wlosia ognistego wierzchowca
            bowstrFiresteed.WeaponDamageIncrease = 5;
            bowstrFiresteed.WeaponFireDamage = 20;

            CraftAttributeInfo bowstrUnicorn = BowstringUnicorn  = new CraftAttributeInfo();	// Cieciwa z wlosia jednorozca
            bowstrUnicorn.WeaponDamageIncrease = 5;
            bowstrUnicorn.WeaponColdDamage = 20;

            CraftAttributeInfo bowstrNightmare = BowstringNightmare  = new CraftAttributeInfo();	// Cieciwa z wlosia koszmara
            bowstrNightmare.WeaponDamageIncrease = 5;
            bowstrNightmare.WeaponPoisonDamage = 20;

            CraftAttributeInfo bowstrKirin = BowstringKirin  = new CraftAttributeInfo();	// Cieciwa z wlosia kirina
            bowstrKirin.WeaponDamageIncrease = 5;
            bowstrKirin.WeaponEnergyDamage = 20;
	...
	public class CraftResources
	{
		...
		private static CraftResourceInfo[] m_WoodInfo = new CraftResourceInfo[]
			{
				...
				new CraftResourceInfo( 1801,  1072534, "Ash",			CraftAttributeInfo.AshWood,		CraftResource.AshWood,		typeof( AshLog ),		typeof( AshBoard ) ),
				new CraftResourceInfo( 0x393,  1072535, "Yew",			CraftAttributeInfo.YewWood,		CraftResource.YewWood,		typeof( YewLog ),		typeof( YewBoard ) ),
				new CraftResourceInfo( 1436,  1072536, "Heartwood",		CraftAttributeInfo.Heartwood,	CraftResource.Heartwood,	typeof( HeartwoodLog ),	typeof( HeartwoodBoard ) ),
				new CraftResourceInfo( 1627,  1072538, "Bloodwood",		CraftAttributeInfo.Bloodwood,	CraftResource.Bloodwood,	typeof( BloodwoodLog ),	typeof( BloodwoodBoard ) ),
        ...
        private static CraftResourceInfo[] m_BowstringInfo = new CraftResourceInfo[]
			{
				new CraftResourceInfo( 1132, 0, "Skorzana cieciwa",	CraftAttributeInfo.BowstringLeather,    CraftResource.BowstringLeather,		typeof( BowstringLeather ) ),
				new CraftResourceInfo( 1164, 0, "Konopna cieciwa",	CraftAttributeInfo.BowstringCannabis,	CraftResource.BowstringCannabis,	typeof( BowstringCannabis ) ),
				new CraftResourceInfo( 2886, 0, "Jedwabna cieciwa",	CraftAttributeInfo.BowstringSilk,	    CraftResource.BowstringSilk,		typeof( BowstringSilk ) ),
                new CraftResourceInfo( 1141, 0, "Jelitowa cieciwa",	CraftAttributeInfo.BowstringGut,		CraftResource.BowstringGut,			typeof( BowstringGut ) ),
                new CraftResourceInfo( 1359, 0, "Cieciwa z wlosia ognistego rumaka",	CraftAttributeInfo.BowstringFiresteed,	CraftResource.BowstringFiresteed,	typeof( BowstringFiresteed ) ),
                new CraftResourceInfo( 1363, 0, "Cieciwa z wlosia jednorozca",	        CraftAttributeInfo.BowstringUnicorn,	CraftResource.BowstringUnicorn,		typeof( BowstringUnicorn ) ),
                new CraftResourceInfo( 2065, 0, "Cieciwa z wlosia koszmara",	        CraftAttributeInfo.BowstringNightmare,	CraftResource.BowstringNightmare,	typeof( BowstringNightmare ) ),
                new CraftResourceInfo( 2517, 0, "Cieciwa z wlosia ki-rina",	            CraftAttributeInfo.BowstringKirin,		CraftResource.BowstringKirin,		typeof( BowstringKirin ) ),
                new CraftResourceInfo( 0x8AC, 0, "Cieciwa z niebieskiej skory",	CraftAttributeInfo.BowstringSpined,   	        CraftResource.BowstringSpined,		typeof( BowstringSpinedLeather ) ),
                new CraftResourceInfo( 0x845, 0, "Cieciwa z czerwonej skory",	CraftAttributeInfo.BowstringHorned,   	        CraftResource.BowstringHorned,		typeof( BowstringHornedLeather ) ),
                new CraftResourceInfo( 0x851, 0, "Cieciwa z zielonej skory",	CraftAttributeInfo.BowstringBarbed,   	        CraftResource.BowstringBarbed,		typeof( BowstringBarbedLeather ) ),
			};
		...
		{
			return ( resource == CraftResource.None || resource == CraftResource.Iron || resource == CraftResource.RegularLeather || resource == CraftResource.RegularWood || resource == CraftResource.RedScales || resource == CraftResource.BowstringLeather );
		}
		...
		public static CraftResourceInfo GetInfo( CraftResource resource )
		{
			...
			switch ( GetType( resource ) )
			{
                ...
                case CraftResourceType.Bowstring: list = m_BowstringInfo; break;
			}
		...
		{
			if ( (resource >= CraftResource.Iron && resource <= CraftResource.Valorite) || resource == CraftResource.Platinum)
			...
			if ( resource >= CraftResource.BowstringLeather && resource <= CraftResource.BowstringBarbed )
				return CraftResourceType.Bowstring;
		...
		public static CraftResource GetStart( CraftResource resource )
		{
			switch ( GetType( resource ) )
			{
                ...
                case CraftResourceType.Bowstring: return CraftResource.BowstringLeather;
			}
