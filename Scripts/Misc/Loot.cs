...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_RangedWeaponTypes = new Type[]
			{
				typeof( Bow ), typeof(MagicalShortbow), typeof(ElvenCompositeLongbow),					typeof( Crossbow ),				typeof( HeavyCrossbow )
			};
		...
		private static Type[] m_ArmorTypes = new Type[]
			{
				...
				typeof( StuddedGorget ),		typeof( StuddedLegs ), typeof (WoodlandChest), typeof (WoodlandGorget), typeof (WoodlandLegs), typeof (WoodlandGloves),
				typeof(LeafChest), typeof(LeafTonlet), typeof(LeafLegs), typeof(LeafGorget), typeof(LeafGloves), typeof(LeafArms), typeof(HidePauldrons), typeof(HidePants), typeof(HideGorget),
				typeof(HideGloves), typeof(HideFemaleChest), 				typeof( ChainHatsuburi ),		typeof( LeatherDo ),			typeof( LeatherHaidate ),
				typeof( LeatherHiroSode ),		typeof( LeatherJingasa ),		typeof( LeatherMempo ),
				typeof( LeatherNinjaHood ),		typeof( LeatherNinjaJacket ),	typeof( LeatherNinjaMitts ),
				typeof( LeatherNinjaPants ),	typeof( LeatherSuneate ),		typeof( DecorativePlateKabuto ),
				typeof( HeavyPlateJingasa ),	typeof( LightPlateJingasa ),	typeof( PlateBattleKabuto ),
        ...
        public static Item RandomRangedWeaponOrJewelry()
        {
            if (Core.SE)
                return Construct(m_SERangedWeaponTypes, m_AosRangedWeaponTypes, m_RangedWeaponTypes, m_JewelryTypes);

            if (Core.AOS)
                return Construct(m_AosRangedWeaponTypes, m_RangedWeaponTypes, m_JewelryTypes);

            return Construct(m_RangedWeaponTypes, m_JewelryTypes);
        }
		...
		{
			if ( Core.SE )
				return Construct( /*m_SEArmorTypes, m_SEHatTypes,*/ m_ArmorTypes,  m_AosHatTypes, m_HatTypes );
		...
		{
			if ( Core.SE )
				return Construct( /*m_SEArmorTypes, m_SEHatTypes,*/ m_ArmorTypes, m_AosHatTypes, m_HatTypes, m_AosShieldTypes, m_ShieldTypes, m_JewelryTypes );
		...
		{
			if ( Core.SE )
				return Construct( /*m_SEArmorTypes, m_SEHatTypes,*/ m_SEWeaponTypes, m_AosWeaponTypes, m_WeaponTypes, m_SERangedWeaponTypes, m_AosRangedWeaponTypes, m_RangedWeaponTypes, m_ArmorTypes, m_AosHatTypes, m_HatTypes, m_AosShieldTypes, m_ShieldTypes );
		...
		{
			if ( Core.SE )
				return Construct( /*m_SEArmorTypes, m_SEHatTypes,*/ m_SEWeaponTypes, m_AosWeaponTypes, m_WeaponTypes, m_SERangedWeaponTypes, m_AosRangedWeaponTypes, m_RangedWeaponTypes, m_ArmorTypes,  m_AosHatTypes, m_HatTypes, m_AosShieldTypes, m_ShieldTypes, m_JewelryTypes );
