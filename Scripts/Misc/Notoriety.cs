...
namespace Server.Misc
{
	public class NotorietyHandlers
	{
		public static void Initialize()
		{
            ...
            // 07.07.2012 :: zombie :: zmiana hue reda
			Notoriety.Hues[Notoriety.Murderer]		= 0x25;
            // zombie
		...
		public static int MobileNotoriety( Mobile source, Mobile target )
		{
            ...
            if ( target.Kills >= 5 ||
                ( target.Body.IsMonster && IsSummoned( target as BaseCreature ) && !( target is BaseFamiliar ) && !( target is ArcaneFey ) && !( target is Golem ) ) ||
            ...
            if (target is BaseCreature && ((BaseCreature)target).GetMaster() != null)
            {
                ...
                if (master.Kills >= 5)
                    return Notoriety.Murderer;
                if (master is BaseCreature && ((BaseCreature)master).AlwaysMurderer)
                    return Notoriety.Murderer;
            ...
            // ofiara kradziezy moze atakowac zlodzieja:
