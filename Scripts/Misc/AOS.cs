...
namespace Server
{
	public class AOS
	{
        ...
        // 13.07.2012 :: zombie :: dodanie kolczanow + poprawka do deathstrike
		...
		public static int Damage( Mobile m, Mobile from, int damage, bool ignoreArmor, int phys, int fire, int cold, int pois, int nrgy, int chaos, int direct, bool keepAlive, bool archer, bool deathStrike )
		{
			...
			if( (!Core.AOS || from == null || !from.Player) && m.Player && (m.Mount is SwampDragon || m.Mount is NBaseWarHorse) )
			{
				...
				NBaseWarHorse horse = m.Mount as NBaseWarHorse;

				if( horse != null && horse.HasBarding )
				{
					int percent = (horse.BardingExceptional ? 20 : 10);
					int absorbed = Scale( totalDamage, percent );

					totalDamage -= absorbed;
					horse.BardingHP -= absorbed;

					if( horse.BardingHP < 0 )
					{
						horse.HasBarding = false;
						horse.BardingHP = 0;
	...
	public sealed class AosAttributes : BaseAttributes
	{
		...
		public static int GetValue( Mobile m, AosAttribute attribute )
		{
			...
			for( int i = 0; i < items.Count; ++i )
			{
				...
				// 19.10.2012 mortuus - nie zwracaj wartosci propsa na niezidentyfikowanym przedmiocie:
				if( obj is IIdentifiable && ((IIdentifiable)obj).Identified == false )
					continue;
			...
			if (attribute == AosAttribute.SpellDamage) {
        ...
        // 13.07.2012 :: zombie :: dodanie kolczanow z RunUO 2.2
		...
		public int RegenHitsId(bool identified) { return identified ? RegenHits : 0 ; }
		public int RegenStamId(bool identified) { return identified ? RegenStam : 0 ; }
		public int RegenManaId(bool identified) { return identified ? RegenMana : 0 ; }
		public int DefendChanceId(bool identified) { return identified ? DefendChance : 0 ; }
		public int AttackChanceId(bool identified) { return identified ? AttackChance : 0 ; }
		public int BonusStrId(bool identified) { return identified ? BonusStr : 0 ; }
		public int BonusDexId(bool identified) { return identified ? BonusDex : 0 ; }
		public int BonusIntId(bool identified) { return identified ? BonusInt : 0 ; }
		public int BonusHitsId(bool identified) { return identified ? BonusHits : 0 ; }
		public int BonusStamId(bool identified) { return identified ? BonusStam : 0 ; }
		public int BonusManaId(bool identified) { return identified ? BonusMana : 0 ; }
		public int WeaponDamageId(bool identified) { return identified ? WeaponDamage : 0 ; }
		public int WeaponSpeedId(bool identified) { return identified ? WeaponSpeed : 0 ; }
		public int SpellDamageId(bool identified) { return identified ? SpellDamage : 0 ; }
		public int CastRecoveryId(bool identified) { return identified ? CastRecovery : 0 ; }
		public int CastSpeedId(bool identified) { return identified ? CastSpeed : 0 ; }
		public int LowerManaCostId(bool identified) { return identified ? LowerManaCost : 0 ; }
		public int LowerRegCostId(bool identified) { return identified ? LowerRegCost : 0 ; }
		public int ReflectPhysicalId(bool identified) { return identified ? ReflectPhysical : 0 ; }
		public int EnhancePotionsId(bool identified) { return identified ? EnhancePotions : 0 ; }
		public int LuckId(bool identified) { return identified ? Luck : 0 ; }
		public int SpellChannelingId(bool identified) { return identified ? SpellChanneling : 0 ; }
	//	public int NightSightId(bool identified) { return identified ? NightSight : 0 ; }
	}
	...
	public sealed class AosWeaponAttributes : BaseAttributes
	{
		...
		public static int GetValue( Mobile m, AosWeaponAttribute attribute )
		{
			...
			for( int i = 0; i < items.Count; ++i )
			{
				...
				// 19.10.2012 mortuus - nie zwracaj wartosci propsa niezidentyfikowanej broni:
				if( obj is IIdentifiable )
					if( ! ((IIdentifiable)obj).Identified )
						continue;
		...
		public int LowerStatReqId(bool identified) { return identified ? LowerStatReq : 0 ; }
		public int SelfRepairId(bool identified) { return identified ? SelfRepair : 0 ; }
		public int HitLeechHitsId(bool identified) { return identified ? HitLeechHits : 0 ; }
		public int HitLeechStamId(bool identified) { return identified ? HitLeechStam : 0 ; }
		public int HitLeechManaId(bool identified) { return identified ? HitLeechMana : 0 ; }
		public int HitLowerAttackId(bool identified) { return identified ? HitLowerAttack : 0 ; }
		public int HitLowerDefendId(bool identified) { return identified ? HitLowerDefend : 0 ; }
		public int HitMagicArrowId(bool identified) { return identified ? HitMagicArrow : 0 ; }
		public int HitHarmId(bool identified) { return identified ? HitHarm : 0 ; }
		public int HitFireballId(bool identified) { return identified ? HitFireball : 0 ; }
		public int HitLightningId(bool identified) { return identified ? HitLightning : 0 ; }
		public int HitDispelId(bool identified) { return identified ? HitDispel : 0 ; }
		public int HitColdAreaId(bool identified) { return identified ? HitColdArea : 0 ; }
		public int HitFireAreaId(bool identified) { return identified ? HitFireArea : 0 ; }
		public int HitPoisonAreaId(bool identified) { return identified ? HitPoisonArea : 0 ; }
		public int HitEnergyAreaId(bool identified) { return identified ? HitEnergyArea : 0 ; }
		public int HitPhysicalAreaId(bool identified) { return identified ? HitPhysicalArea : 0 ; }
		public int ResistPhysicalBonusId(bool identified) { return identified ? ResistPhysicalBonus : 0 ; }
		public int ResistFireBonusId(bool identified) { return identified ? ResistFireBonus : 0 ; }
		public int ResistColdBonusId(bool identified) { return identified ? ResistColdBonus : 0 ; }
		public int ResistPoisonBonusId(bool identified) { return identified ? ResistPoisonBonus : 0 ; }
		public int ResistEnergyBonusId(bool identified) { return identified ? ResistEnergyBonus : 0 ; }
		public int UseBestSkillId(bool identified) { return identified ? UseBestSkill : 0 ; }
		public int MageWeaponId(bool identified) { return identified ? MageWeapon : 0 ; }
		public int DurabilityBonusId(bool identified) { return identified ? DurabilityBonus : 0 ; }
	}
	...
	public sealed class AosArmorAttributes : BaseAttributes
	{
		...
		public static int GetValue( Mobile m, AosArmorAttribute attribute )
		{
			...
			for( int i = 0; i < items.Count; ++i )
			{
				...
				// 19.10.2012 mortuus - nie zwracaj wartosci propsa niezidentyfikowanej zbroi:
				if( obj is IIdentifiable )
					if( ! ((IIdentifiable)obj).Identified )
						continue;
		...
		public int LowerStatReqId(bool identified) { return identified ? LowerStatReq : 0; }
		public int SelfRepairId(bool identified) { return identified ? SelfRepair : 0; }
		public int MageArmorId(bool identified) { return identified ? MageArmor : 0; }
		public int DurabilityBonusId(bool identified) { return identified ? DurabilityBonus : 0; }
	}
	...
	public sealed class AosSkillBonuses : BaseAttributes
	{
        ...
        // zombie :: 15.10.2012 :: wyswietlanie nazw umiejetnosci bez wartosci
        public void GetProperties( ObjectPropertyList list )
        {
            GetProperties( list, true );
        }

		public void GetProperties( ObjectPropertyList list, bool identified )
		{
			for( int i = 0; i < 5; ++i )
			{
				SkillName skill;
                ...
                //ItemIdentification.AddNameSkillProperty(skill, bonus, ref list, identified);
	...
	public sealed class AosElementAttributes : BaseAttributes
	{
		...
		public int PhysicalId(bool identified) { return identified ? (int)Physical : 0 ; }
		public int FireId(bool identified) { return identified ? (int)Fire : 0 ; }
		public int ColdId(bool identified) { return identified ? (int)Cold : 0 ; }
		public int PoisonId(bool identified) { return identified ? (int)Poison : 0 ; }
		public int EnergyId(bool identified) { return identified ? (int)Energy : 0 ; }
	}
		...
		public void SetValue( int bitmask, int value )
		{
			...
			if( m_Owner.Parent is Mobile )
			{
				...
				if( this is AosSkillBonuses )
				{
					...
					((AosSkillBonuses)this).AddTo( m, true );
				}
			}
