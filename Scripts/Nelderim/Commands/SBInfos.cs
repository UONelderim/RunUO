...
{ 
	public class SBInfosCommand
    {
        ...
        public static void CraftInfos_OnCommand(CommandEventArgs e)
        {
            ...
            systems.Add(DefWandCrafting.CraftSystem);

            string LogsDirectory = "Logi/SBInfos";
            ...
            foreach (CraftSystem sys in systems)
            {
                ...
                {
                    CraftRes res;
                    if (item.UseSubRes2 && item.Ressources.Count > 1)
                        res = item.Ressources.GetAt(1);
                    else
                        res = item.Ressources.GetAt(0);
                    ...
                    foreach (SBInfo sb in SBInfosAnalyzer.SBInfos)
                    {
                        ...
                        if (sellInfo != null && sellInfo.Table.ContainsKey(product))
                        {
    ...
    public class SBInfosAnalyzer
    {
        ...
        public static string LogsDirectory = "Logi/SBInfos";
