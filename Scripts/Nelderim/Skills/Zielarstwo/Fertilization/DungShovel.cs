...
namespace Server.Items
{
	public class DungShovel : BaseTool, ICraftable
	{
		...
		public new int OnCraft(int quality, bool makersMark, Mobile from, CraftSystem craftSystem, Type typeRes, Type typeRes2, BaseTool tool, CraftItem craftItem, int resHue)
		{
