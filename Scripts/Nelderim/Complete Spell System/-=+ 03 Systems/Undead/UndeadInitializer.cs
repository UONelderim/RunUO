...
namespace Server.ACC.CSS.Systems.Undead
{
    public class UndeadInitializer : BaseInitializer
    {
		public static void Configure()
		{
           ...
           Register( typeof( UndeadAngelicFaithSpell ),         "Awatar Smierci",   "Rzucający wzywa boskie moce niebios, aby przekształciły się w Awatara Śmerci. Rzucający zyskuje zwiększone statystyki i umiejętności.",                                                       "Mandrake Root; Spring Water; Petrafied Wood",    "Mana: 17;", 2295,  5120, School.Undead );
