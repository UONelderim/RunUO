...
namespace Server.Misc
{
	public class RazorFeatureControl
	{
		...
		public static readonly TimeSpan HandshakeTimeout = TimeSpan.FromSeconds( 1.0 ); // How long to wait for a handshake response before showing warning and disconnecting
        ...
        // 21.11.2012 :: mortuus :: tlumaczenie
		public const string WarningMessage = "Jesli widzisz ten komunikat oznacza to, iz uzywasz Razora bez wlaczonej opcji negocjowania zachowan klienta z serwerem gry. Opcja ta jest konieczna, aby moc grac na naszym shardzie przy uzyciu Razora. Aby ja wlaczyc przejdz w Razorze do zakladki Options (Opcje) i zaznacz na dole po prawej stronie okna \"Negotiate features with server\". Za chwile zostaniesz rozlaczony z serwerem gry.";
        // mortuus
