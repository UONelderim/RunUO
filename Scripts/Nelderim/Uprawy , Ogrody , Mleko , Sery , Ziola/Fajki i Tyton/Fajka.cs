...
namespace Server.Items
{
    public class Fajka : BaseEarrings
    {
        ...
        private static readonly Dictionary<Type, TobaccoInfo> TobaccoDescription = new Dictionary<Type, TobaccoInfo>
        {
            ...
            { typeof(SwampTobacco), new TobaccoInfo("bagienne ziele", PlainTobacco.OnSmoke) },
        };
        ...
        private class ExtractTobacco : ContextMenuEntry
        {
            ...
            private Fajka m_Pipe;

            public ExtractTobacco(Mobile mobile, Fajka pipe) : base(6245)
            {
                m_Mobile = mobile;
                m_Pipe = pipe;
            }
        ...
        private class AddTobacco : ContextMenuEntry
        {
            ...
            public AddTobacco(Mobile mobile, Fajka pipe) : base(6246)
            {
                m_Mobile = mobile;
                m_Pipe = pipe;
            }
        ...
        class TobaccoChoiceTarget : Target
        {
            ...
            public TobaccoChoiceTarget(Fajka pipe) : base(-1, true, TargetFlags.None)
            {
                m_Pipe = pipe;
            }
