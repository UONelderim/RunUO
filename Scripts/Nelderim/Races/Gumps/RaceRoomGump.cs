    ...
    public class RaceRoomGump : Gump
    {
        public RaceRoomGump( Mobile from , RaceRoomType room ) : base( 0, 0 )
        {
            ...
            switch ( room )
            {
                ...
                {
                    this.AddHtmlLocalized( 73, 58, 252, 257, Tamael.Instance.DescNumber, true, true);
                        
                    break;
                }				
				case RaceRoomType.Elf:
                {
                    this.AddHtmlLocalized( 73, 58, 252, 257, Elf.Instance.DescNumber, true, true);
                        
                    break;
                }
				case RaceRoomType.Drow:
                {
                    this.AddHtmlLocalized( 73, 58, 252, 257, Drow.Instance.DescNumber, true, true);
                        
                    break;
                }
				case RaceRoomType.Krasnolud:
                {
                    this.AddHtmlLocalized( 73, 58, 252, 257, Krasnolud.Instance.DescNumber, true, true);
