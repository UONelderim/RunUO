...
namespace Server
{
    public class Krasnolud : Race
    {
        private static Race instance = null;
        public Krasnolud( int raceID, int raceIndex ) : base( raceID, raceIndex, 400, 401, 402, 403, Expansion.None )
        {
        }
        ...
        public static Race Init(int raceID, int raceIndex) {
            if (instance == null) {
                instance = new Krasnolud(raceID, raceIndex);
            }
            return instance;
        }
        ...
        {
            get { return new string[7] { "Krasnolud", "Krasnoluda", "Krasnoludowi", "Krasnoluda", "Krasnoludem", "Krasnoludzie", "Krasnoludzie" }; }
        }

        protected override string[] PluralNames
        {
            get { return new string[7] { "Krasnoludy", "Krasnoludow", "Krasnoludom", "Krasnoludow", "Krasnoludami", "Krasnoludach", "Krasnoludy" }; }
        }
        ...
        {
            get { return new int[] { 1037, 1038, 1039, 1040, 1041, 1042, 1043, 2307, 2308, 2309, 2310, 2311 }; }
        }
