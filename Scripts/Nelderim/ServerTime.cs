// 05.03.28 :: troyan :: Wprowadzenie systemu czasu Nelderim
// 05.04.04 :: troyan :: wprowadzenie pr roku + poprawka czasowa 
// 05.04.11 :: troyan :: korekty w kolejnosci miesiecy
// 05.04.15 :: troyan :: wylaczenie ServerWeather, dopasowanie do nowej pogody
// 05.04.26 :: troyan :: wylaczenie poprawki czasowej
// 05.06.25 :: troyan :: dodanie polecenia recznie ustalajacego date
// 05.07.08 :: troyan :: poprawki zwiazane z ustalaniem pory roku dla regionow
// 05.08.15 :: troyan :: naprawa bledu zmiany light level przy zmianie pory roku
// 05.09.08 :: troyan :: nowa klasa NelderimDateTime do przeliczania dat swiata
// 05.09.13 :: troyan :: przywrocenie Moonphase dla XMLSpawnera
// 05.10.02 :: troyan :: polecenie [timeconvert i [timemonths oraz danie [timeget graczom
// 05.10.08 :: troyan :: zmiana priorytetow timerow
// 06.01.08 :: troyan :: zabezpieczenia
// 06.02.12 :: troyan :: usuniecie locka prawdopodobnie blokujacego serwer
// 15.04.10 :: mortuus :: Zmiana punktu synchronizacji czasu gry z czasem rzeczywistym
...
namespace Server
{
	...
	public class ServerTime
	{
		...
		static ServerTime()
		{
			...
			SynchronizeTime();
			LightCycle.EvaluateGlobalLight();
		}
