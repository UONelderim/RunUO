		...
		private static StealableEntry[] m_Entries = new StealableEntry[]
			{
				...
				new StealableEntry( Map.Felucca, new Point3D( 665,  1476, 45 ), 18432, 27648, typeof( PrzekletaVioletCourage ) ), // Alcala

				new StealableEntry( Map.Malas, new Point3D( 258,  772, 1 ), 18432, 27648, typeof( PrzekletyArcticDeathDealer) ),  // Jaskina Blyskow
