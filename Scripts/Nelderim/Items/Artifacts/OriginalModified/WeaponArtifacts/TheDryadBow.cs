...
namespace Server.Items
{
	...
	{
        public override int LabelNumber { get { return 1061090; } } // Luk Driad
		...
		public TheDryadBow()
		{
			ItemID = 0x13B1;
			Hue = 0x48F;
			SkillBonuses.SetValues( 0, m_PossibleBonusSkills[Utility.Random(m_PossibleBonusSkills.Length)], 10.0 );
