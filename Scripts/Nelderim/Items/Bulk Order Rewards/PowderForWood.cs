	...
	public class PowderForWood : Item
	{
		...
		private class InternalTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted ){
				...
				if (targeted is Item && targeted is IDurability && (DefCarpentry.CraftSystem.CraftItems.SearchForSubclass(targeted.GetType()) != null || DefBowFletching.CraftSystem.CraftItems.SearchForSubclass(targeted.GetType()) != null))
                {
