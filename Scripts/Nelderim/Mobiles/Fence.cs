...
namespace Server.Mobiles
{
    public class Fence : BaseVendor
    {
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write( (int)0 ); // AnimalTrainer version
        }
        ...
        public void CheckOperation(SpeechEventArgs e)
        {
            ...
            if (split.Length >= 2)
            {
                ...
                else
                {
                    ...
                    check.LabelOfCreator = (string)CommandLogging.Format(from);
