   	...
   	{ 
		...
		public DragonEgg5() : base( 0x0C5D )
		{
			...
			m_End = DateTime.Now + TimeSpan.FromDays( 1.0 );
            	...
            	public DragonEgg5( Serial serial ) : base ( serial ) 
            	{             
           	}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( this.AllowEvolution == true )
			{
				...
				EvolutionDragon5 dragon = new EvolutionDragon5();
		...
		{ 
			private DragonEgg5 de;

			private int cnt = 0;

			public EvolutionTimer( DragonEgg5 owner, TimeSpan duration ) : base( duration )
			{ 
				de = owner;
			}
