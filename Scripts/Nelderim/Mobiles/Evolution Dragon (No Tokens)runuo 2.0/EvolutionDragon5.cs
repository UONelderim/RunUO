...
namespace Server.Mobiles
{
	...
	public class EvolutionDragon5 : BaseCreature
	{
		...
		[Constructable]
		public EvolutionDragon5() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			m_PetLoyaltyTimer = new PetLoyaltyTimer5( this, TimeSpan.FromSeconds( 5.0 ) );
			m_PetLoyaltyTimer.Start();
			m_EndPetLoyalty = DateTime.Now + TimeSpan.FromSeconds( 5.0 );
		}

		public EvolutionDragon5(Serial serial) : base(serial)
		{
		}
			...
			if ( this.Stage == 1 )
			{
				...
				if ( this.KP >= 25000 )
				{
					if ( this.S1 == true )
					{
			            ...
			            this.SetResistance( ResistanceType.Poison, 0, 5 );
			...
			else if ( this.Stage == 2 )
			{
				...
				if ( this.KP >= 75000 )
				{
					if ( this.S2 == true )
					{
			            ...
			            this.SetResistance( ResistanceType.Energy, 60, 65 );
			...
			else if ( this.Stage == 4 )
			{
				...
				if ( this.KP >= 3750000 )
				{
					if ( this.S4 == true )
					{
			            ...
			            this.SetResistance( ResistanceType.Energy, 70, 75 );
			...
			else if ( this.Stage == 5 )
			{
				...
				if ( this.KP >= 7750000 )
				{
					if ( this.S5 == true )
					{
			            ...
			            this.SetResistance( ResistanceType.Physical, 60, 65 );
			            this.SetResistance( ResistanceType.Cold, 30, 32 );
			            this.SetResistance( ResistanceType.Fire, 45, 46 );
			...
			else if ( this.Stage == 6 )
			{
				...
				if ( this.KP >= 15000000 )
				{
					if ( this.S6 == true )
					{
						...
						SetResistance( ResistanceType.Fire, 46, 50 );
						SetResistance( ResistanceType.Cold, 32, 35 );
						SetResistance( ResistanceType.Poison, 22, 25 );
		...
		public override bool OnDragDrop( Mobile from, Item dropped )
		{
			...
			return base.OnDragDrop( from, dropped );
                ...
                { 
                           	if ( obj is EvolutionDragon5 && obj is BaseCreature ) 
                           	{ 
					...
					if ( ed.Controlled == true && ed.ControlMaster == from )
					{
						if ( ed.Female == false )
						{
							if ( ed.AllowMating == true )
							{
								...
								m_MatingTimer = new MatingTimer5( this, TimeSpan.FromDays( 3.0 ) );
								m_MatingTimer.Start();
					...
					else if ( ed.Controlled == true )
					{
						if ( ed.Female == false )
						{
							if ( ed.AllowMating == true )
							{
								...
								{
									ed.ControlMaster.SendGump( new MatingGump5( from, ed.ControlMaster, this, ed ) );
					...
					if ( this.AllowMating == true )
					{
						if ( this.Pregnant == true )
						{
							if ( this.HasEgg == true )
							{
								...
								this.Pregnant = false;
								this.Blessed = false;
								from.AddToBackpack( new DragonEgg5() );
		...
		{
			private EvolutionDragon5 ed;
			private Mobile m_Mobile, m_From;

			public BreatheTimer( Mobile m, EvolutionDragon5 owner, Mobile from, TimeSpan duration ) : base( duration ) 
			{
				ed = owner;
				m_Mobile = m;
				m_From = from;
		...
		public override void Deserialize(GenericReader reader)
		{
			...
			switch ( version )
			{
				case 1:
				{
					...
					m_MatingTimer = new MatingTimer5( this, m_EndMating - DateTime.Now );
					m_MatingTimer.Start();
					...
					m_PetLoyaltyTimer = new PetLoyaltyTimer5( this, m_EndPetLoyalty - DateTime.Now );
					m_PetLoyaltyTimer.Start();
				...
				case 0:
				{
					...
					m_MatingTimer = new MatingTimer5( this, durationmating );
					m_MatingTimer.Start();
					m_EndMating = DateTime.Now + durationmating;

					m_PetLoyaltyTimer = new PetLoyaltyTimer5( this, durationloyalty );
					m_PetLoyaltyTimer.Start();
	...
	public class MatingTimer5 : Timer
	{ 
		private EvolutionDragon5 ed;

		public MatingTimer5( EvolutionDragon5 owner, TimeSpan duration ) : base( duration ) 
		{ 
	...
	public class PetLoyaltyTimer5 : Timer
	{ 
		private EvolutionDragon5 ed;

		public PetLoyaltyTimer5( EvolutionDragon5 owner, TimeSpan duration ) : base( duration ) 
		{ 
			Priority = TimerPriority.OneSecond;
			ed = owner;
		}
		...
		protected override void OnTick() 
		{
			...
			PetLoyaltyTimer5 lt = new PetLoyaltyTimer5( ed, TimeSpan.FromSeconds( 5.0 ) );
			lt.Start();
	...
	public class MatingGump5 : Gump
	{
		private Mobile m_From;
		private Mobile m_Mobile;
		private EvolutionDragon5 m_ED1;
		private EvolutionDragon5 m_ED2;

		public MatingGump5( Mobile from, Mobile mobile, EvolutionDragon5 ed1, EvolutionDragon5 ed2 ) : base( 25, 50 )
		{
			Closable = false; 
			Dragable = false; 
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			if ( info.ButtonID == 1 )
			{
				...
				MatingTimer5 mt = new MatingTimer5( m_ED1, TimeSpan.FromDays( 3.0 ) );
				mt.Start();
