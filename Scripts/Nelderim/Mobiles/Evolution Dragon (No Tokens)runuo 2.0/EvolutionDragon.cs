...
namespace Server.Mobiles
{
	...
	public class EvolutionDragon : BaseCreature
	{
		...
		public EvolutionDragon() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetResistance( ResistanceType.Poison, 0, 10 );
			...
			if ( this.Stage == 1 )
			{
				...
				if ( this.KP >= 2500 )
				{
					if ( this.S1 == true )
					{
						...
						this.SetResistance( ResistanceType.Poison, 0, 10 );
			...
			else if ( this.Stage == 5 )
			{
				...
				if ( this.KP >= 775000 )
				{
					if ( this.S5 == true )
					{
						...
						this.SetResistance( ResistanceType.Poison, 30, 32 );
			...
			else if ( this.Stage == 6 )
			{
				...
				if ( this.KP >= 1500000 )
				{
					if ( this.S6 == true )
					{
						...
						SetResistance( ResistanceType.Fire, 66, 68 );
						SetResistance( ResistanceType.Cold, 22, 25 );
						SetResistance( ResistanceType.Poison, 32, 35 );
