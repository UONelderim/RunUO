   	...
   	{ 
		...
		public DragonEgg2() : base( 0x0C5D )
		{
			...
			m_End = DateTime.Now + TimeSpan.FromDays( 1.0 );
            	...
            	public DragonEgg2( Serial serial ) : base ( serial ) 
            	{             
           	}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( this.AllowEvolution == true )
			{
				...
				EvolutionDragon2 dragon = new EvolutionDragon2();
		...
		{ 
			private DragonEgg2 de;

			private int cnt = 0;

			public EvolutionTimer( DragonEgg2 owner, TimeSpan duration ) : base( duration )
			{ 
				de = owner;
			}
