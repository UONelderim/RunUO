   	...
   	{ 
		...
		public DragonEgg4() : base( 0x0C5D )
		{
			...
			m_End = DateTime.Now + TimeSpan.FromDays( 1.0 );
            	...
            	public DragonEgg4( Serial serial ) : base ( serial ) 
            	{             
           	}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else if ( this.AllowEvolution == true )
			{
				...
				EvolutionDragon4 dragon = new EvolutionDragon4();
		...
		{ 
			private DragonEgg4 de;

			private int cnt = 0;

			public EvolutionTimer( DragonEgg4 owner, TimeSpan duration ) : base( duration )
			{ 
				de = owner;
			}
