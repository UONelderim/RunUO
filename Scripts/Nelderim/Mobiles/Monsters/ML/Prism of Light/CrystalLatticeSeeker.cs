...
{ 
	[CorpseName( "resztki kryształowego poszukiwacza spokoju" )] 
	public class CrystalLatticeSeeker : BaseCreature 
	{ 
		public override double DifficultyScalar{ get{ return 1.02; } }
		[Constructable] 
		public CrystalLatticeSeeker() : base( AIType.AI_BattleMage, FightMode.Closest, 12, 1, 0.2, 0.4 ) 
		{		
			Name = "Kryształowy Poszukiwacz Spokoju";
			Body = 0x7B;
			Hue = 0x47E;
