...
{
	[CorpseName( "rozgnieciona miasma" )]	
	public class Miasma : BaseCreature
	{
		public override double DifficultyScalar{ get{ return 1.11; } }
		[Constructable]
		public Miasma() : base( AIType.AI_Melee, FightMode.Closest, 12, 1, 0.05, 0.2 )
		{
			Name = "miasma";
			Body = 0x30;	
			Hue = 0x8FD;		
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (int)0 ); // Scorpion version
		}
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			if ( version > 0 )
				reader.ReadInt(); // Scorpion version
		}
	}
}