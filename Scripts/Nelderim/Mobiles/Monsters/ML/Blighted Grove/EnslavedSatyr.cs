...
{
	[CorpseName( "zniewolony satyr" )] 
	public class EnslavedSatyr : BaseCreature
	{	
		[Constructable]
		public EnslavedSatyr() : base( AIType.AI_Animal, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
			Name = "zniewolony satyr";
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (int)0 ); // Satyr version
		}
