...
{
	[CorpseName( "resztki królowej wróżek" )]
	public class LadyMelisande : BasePeerless
	{
		...
		[Constructable]
		public LadyMelisande() : base( AIType.AI_NecroMage, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
			Name = "Królowa Wróżek";
			Body = 0x102;
			BaseSoundID = 451;
            ...
            Timer timer = Timer.DelayCall( TimeSpan.FromSeconds( 1 ), new TimerCallback( SpawnSatyrs ) );
