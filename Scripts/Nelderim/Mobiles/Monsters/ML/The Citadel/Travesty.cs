...
namespace Server.Mobiles
{
	...
	[CorpseName( "ciało nasladowcy" )]
	public class Travesty : BasePeerless
	{
		public override double DifficultyScalar{ get{ return 1.20; } }
		[Constructable]
		public Travesty() : base( AIType.AI_Melee, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
		...
		public override void SpawnHelpers()
		{
			...
			for ( int i = 0; i < 10; i++ )
			{
				switch ( Utility.Random( 3 ) )
				{
					case 0: SpawnHelper( new DragonsFlameMage(), 5 ); break;
					case 1: SpawnHelper( new SerpentsFangAssassin(), 5 ); break;
					case 2: SpawnHelper( new TigersClawThief(), 5 ); break;
				}
			}
		}
		#endregion
