...
{
	[CorpseName( "zgliszcza Paroxymusa" )]
	public class ChiefParoxysmus: BasePeerless
	{
		[Constructable]
		public ChiefParoxysmus() : base( AIType.AI_Melee, FightMode.Closest, 12, 1, 0.2, 0.4 )
		{
			Name = "Paroxymus - ociekający kwasem";
			Body = 0x100;
		...
		public override void OnDeath( Container c )
		{
			...
			{
				case 0: c.DropItem( new ObsidianStone() ); break;
				case 1: c.DropItem( new FireRuby() ); break;
				case 2: c.DropItem( new DragonsBlood() ); break;
			}
		...
		{
			AddLoot( LootPack.RogueScrollScrolls );
		...
		public virtual void SpawnBulbous()
		{
			for ( int i = 0; i < 3; i ++ )
			{
				Mobile blobus = new GiantSerpent();
