// 28.01.2013 mortuus - Szeol przeniesiony ze starego Nelderim, odrobine dopasowany do obecnych skryptow.
...
namespace Server.Mobiles
{
	...
	public class NSzeol : BaseCreature
	{
		...
		private const double ChanceToThrowWeb = 10; // 25% chance for throwing web
		...
		/*
		// 28.01.2013 mortuus - "rage attack" - to cos w ogole robi poza wygladem??? wywalam (zwlaszcza ze timer potrzebny z innych plikow, ktorych nie mamy).
