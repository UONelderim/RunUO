// 05.09.22 :: troyan
// 05.10.09 :: troyan :: potwierdzeni uczestnicy sa wypisywani w statusie - IRCBot speaker
// 05.11.03 :: troyan :: cliloc, nagrody za kolejne miejsca, IRCBot kosmetyka
// 05.12.25 :: troyan :: podmiana Finalize na Final
// 06.02.02 :: troyan :: modyfikacje funkcji bankowych
// 06.02.19 :: troyan :: naprawa zlego czasu startu turnieju po restarcie
// 06.03.16 :: troyan :: zwiekszenie zasiegu poszukiwania zawodnikow do walki na 15
...
namespace Server.Engines.Tournament
{
	...
	public class TournamentCompetitor
	{
		...
		public TournamentCompetitor( GenericReader reader )
		{
			...
			m_Serial = (Serial)reader.ReadInt();
		}
	...
	public class Tournament
	{
		...
		private bool IRC { get { return m_Owner.TrnIRCComments; } }
