// 05.09.22 :: troyan
// 05.09.24 :: troyan :: OnSpeech przeniesienie miejsca odwolania do base
// 05.09.24 :: troyan :: przy aktywacji i braku m_Tournament ustawiamy stan turniej na NONE (blad z "turniej informacje")
// 05.09.25 :: troyan :: poprawka ostatniej poprawki + naprawa bledu z czasem startu recznym
// 05.09.30 :: troyan :: naprawa bledu zlych wspolrzednych regionow
// 05.09.30 :: troyan :: blokada areny dla Young
// 05.09.30 :: troyan :: zarzadca uczy Bushido
// 05.10.02 :: troyan :: do turnieju mozna sie zglosic az po roostering
// 05.10.02 :: troyan :: naprawa zglaszania do turnieju w trakcie roosteringu
// 05.10.08 :: troyan :: wylaczenie raportow
// 05.10.09 :: troyan :: prop do rozglaszania na IRCu wynikow turnieju
// 05.11.02 :: troyan :: cliloc, contextmenu, nagrody za kolejne miejsca
// 06.02.02 :: troyan :: zasiegi menu kontekstowego + usuniecie funkcji banku
// 07.11.26 :: emfor :: Wydluzenie czasu w przod do 5 dni podczas fundowania turnieju
...
namespace Server.Mobiles
{
	public class ArenaTrainer : BaseVendor
	{
		...
		{ 
			get { return m_TournamentPassToIRCBot; }
...
//				    && ( m_TournamentStart < DateTime.Now + TimeSpan.FromSeconds( ( int ) TournamentIntervals.Day ) ) )
		...
		public ArenaRegion Arena { get { return m_Arena; } }
		...
		public override void Deserialize( GenericReader reader )
		{
			...
			switch ( version )
			{
				...
				case 9:
					{
						m_TournamentFounderSerial = new Serial();
						m_TournamentFounderSerial = (Serial)reader.ReadInt();
			...
			if ( m_Active )
			{
				m_Arena = new ArenaRegion( "arena", this.Map, null, this );
				m_Arena.Owner = this;
				ActivateArena();
			}
		...
		private bool ActivateArena()
		{
			try
			{
				...
				else 
				{
					...
					m_Arena = new ArenaRegion( "arena", this.Map, new Rectangle3D[]{ rect }, this );
