...
namespace Server.Engines.Harvest
{
	public class Bivalvia : HarvestSystem
	{
		...
		private Bivalvia()
		{
			...
			shell.ConsumedPerHarvestMin = 5;
			shell.ConsumedPerHarvestMax = 5;
			...
			shell.MinTotal = 2 * shell.ConsumedPerHarvestMax;
			shell.MaxTotal = 2 * shell.ConsumedPerHarvestMax;
			...
			shell.Skill = SkillName.Zielarstwo;
