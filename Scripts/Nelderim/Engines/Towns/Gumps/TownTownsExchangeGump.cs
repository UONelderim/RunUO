    ...
    public class TownTownsExchangeGump : Gump
    {
            ...
            : base(50, 40)
        {
            ...
            else 
            {
                ...
                {
                    AddLabel(10, yLab, SelectedColor, t.GetType().ToString());
                    if (t.GetType() == TownResourceType.Zloto)
                    {
                        AddButton(150, yLab, 100 + (int)t.GetType(), "5000");
                        AddButton(230, yLab, 200 + (int)t.GetType(), "10000");
                    }
                    else
                    {
                        AddButton(150, yLab, 100 + (int)t.GetType(), "100");
                        AddButton(230, yLab, 200 + (int)t.GetType(), "1000");
                    }
                    yLab += 20;
                }
