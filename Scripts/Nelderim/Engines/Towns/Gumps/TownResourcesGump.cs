...
namespace Server.Gumps
{
				...
				case TownResourcesGumpPage.Citizens:
                {
                    ...
                    switch (subpage)
                    {
                        ...
                        case TownResourcesGumpSubpages.ToplistCitizens:
                            ...
                            perPage = 10;
                            Dictionary<Mobile, int> m_cits_by_resources = TownDatabase.GetCitizensByResource(m_Town.Town, (TownResourceType)subpageindex);
                        ...
                        case TownResourcesGumpSubpages.OldestCitizens:
                            ...
                            perPage = 10;
                            Dictionary<Mobile, DateTime> m_cits_by_date = TownDatabase.GetCitizensByJoinDate(m_Town.Town);
                        ...
                        case TownResourcesGumpSubpages.RemoveCitizen:
                            ...
                            perPage = 10;
                            SortedDictionary<Mobile, string> m_cits_to_remove = TownDatabase.GetCitizensByName(m_Town.Town);
                            // Wyswietlenie listy nazw i rang
                            minIndex = subpageindex * perPage;
    ...
    public class TownRename : Gump
    {
        ...
        public TownRename(DuszaMiasta town): base(50, 40)
		{
            ...
            AddBackground(0, 0, 200, 450, 5054);// Jesli zostanie dodane wiecej miast, wpierw trzeba poszerzyc ten gump, 4 parametr zwiekszyc!
            ...
            : base(50, 40)
        {
            ...
            { 
                ...
                case 10: // Zabierz tytul kanclerza
                    List<Mobile> m_cons_to_remove = TownDatabase.GetCitizensByNameWithStatusAsList(town, TownStatus.Counsellor);
