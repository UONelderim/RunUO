        ...
        public CharacterSheetGump(Mobile from, Mobile target, CSPages page, bool gmRequested)
            ...
            switch (page) {
                ...
                case CSPages.General: {
                        ...
                        {
                            AddPageButton(15, 380, GetButtonID(2, 1, gmRequested), "-1", page,
                                CSPages.CharacterSheetSave);
                            AddPageButton(15, 400, GetButtonID(2, 3, gmRequested), "-3", page,
                                CSPages.CharacterSheetSave);
                            AddPageButton(15, 420, GetButtonID(2, 5, gmRequested), "-5", page,
                                CSPages.CharacterSheetSave);
            ...
            switch (type) {
                case 0: {
                        ...
                        switch (index) {
                            ...
                            {
                                m_FromPlayer.SendGump(new CharacterSheetGump( m_FromPlayer, m_TargetPlayer, CSPages.General, gmRequested));
                                m_FromPlayer.SendGump(new QuestPointsHistoryGump(m_FromPlayer, m_TargetPlayer));
                                return;
                            }
                            default: return;
                        }
                ...
                case 2: {
                        ...
                        m_CharacterSheetInfo.QuestPointsHistoryEntries.Add(
