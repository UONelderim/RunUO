...
{
    public class ChaosKey : TransientItem
    {
        ...
        [Constructable]
        public ChaosKey( ChaosSigilType chaosSigilType ) : base(0x1f16, TimeSpan.FromHours(4))
        {
        ...
        private class UnlockTarget : Target
        {
            ...
            protected override void OnTarget( Mobile from, object targeted )
            {
                ...
                if ( targeted is ChaosChest )
                {
                    ChaosChest chest = (ChaosChest) targeted;
