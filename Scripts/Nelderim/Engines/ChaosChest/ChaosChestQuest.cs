...
namespace Nelderim.Engines.ChaosChest
{
    public class ChaosChestQuest : Item
    {
        ...
        private static Dictionary<string, ChaosSigilType> REGION_MAP = new Dictionary<string, ChaosSigilType>
        {
            ...
            {"Shimmering_VeryEasy", ChaosSigilType.Swiatla},
            {"Shimmering_Easy", ChaosSigilType.Swiatla},
            {"Shimmering_Medium", ChaosSigilType.Swiatla},
            {"Shimmering_Difficult", ChaosSigilType.Swiatla},
            {"Shimmering_VeryDifficult", ChaosSigilType.Swiatla},
