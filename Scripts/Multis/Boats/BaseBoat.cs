...
namespace Server.Multis
{
	...
	public abstract class BaseBoat : BaseMulti
	{
		...
		public uint CreateKeys( Mobile m )
		{
			...
			bankKey.Name = "klucz do statku (zapasowy)";
        ...
        // 07.07.2012 :: zombie :: spolszczenie komend (przeniesione)
    	public override void OnSpeech( SpeechEventArgs e )
		{
			...
			{
				if ( Regex.IsMatch( e.Speech, "nazwac", RegexOptions.IgnoreCase ) )
				{
					SetName( e );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "usunac nazwe", RegexOptions.IgnoreCase ) )
				{
					RemoveName( e.Mobile );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "nazwa", RegexOptions.IgnoreCase ) )
				{
					GiveName( e.Mobile );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "obroc w prawo", RegexOptions.IgnoreCase ) )
				{
					StartTurn(  2, true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "obroc w lewo", RegexOptions.IgnoreCase ) )
				{
					StartTurn(  -2, true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "zawroc", RegexOptions.IgnoreCase ) )
				{
					StartTurn(  -4, true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "opusc kotwice", RegexOptions.IgnoreCase ) )
				{
					LowerAnchor( true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "podnies kotwice", RegexOptions.IgnoreCase ) )
				{
					RaiseAnchor( true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "nawigacja", RegexOptions.IgnoreCase ) )
				{
					GiveNavPoint();
					return;
				}
				if ( Regex.IsMatch( e.Speech, "start", RegexOptions.IgnoreCase ) )
				{
					NextNavPoint = 0;
					StartCourse( false, true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "kontynuowac", RegexOptions.IgnoreCase ) )
				{
					StartCourse( false, true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "plyn", RegexOptions.IgnoreCase ) )
				{
					StartCourse( e.Speech, false, true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "raz", RegexOptions.IgnoreCase ) )
				{
					StartCourse( e.Speech, true, true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "stop", RegexOptions.IgnoreCase ) )
				{
					StopMove( true );
					return;
				}
				if ( Regex.IsMatch( e.Speech, "jeden", RegexOptions.IgnoreCase ) )
				{
					if ( Regex.IsMatch( e.Speech, "jeden naprzod w lewo", RegexOptions.IgnoreCase ) )
					{
						OneMove( ForwardLeft );
					}
					else if ( Regex.IsMatch( e.Speech, "jeden naprzod w prawo", RegexOptions.IgnoreCase ) )
					{
						OneMove( ForwardRight );
					}
					else if ( Regex.IsMatch( e.Speech, "jeden naprzod", RegexOptions.IgnoreCase ) )
					{
						OneMove( Forward );
					}
					else if ( Regex.IsMatch( e.Speech, "jeden w lewo", RegexOptions.IgnoreCase ))
					{
						OneMove( Left );
					}
					else if ( Regex.IsMatch( e.Speech, "jeden w prawo", RegexOptions.IgnoreCase )  )
					{
						OneMove( Right );
					}
					else if ( Regex.IsMatch( e.Speech, "jeden wstecz w prawo", RegexOptions.IgnoreCase ) )
					{
						OneMove( BackwardRight );
					}
					else if ( Regex.IsMatch( e.Speech, "jeden wstecz w lewo", RegexOptions.IgnoreCase )  )
					{
						OneMove( BackwardLeft );
					}
					else if ( Regex.IsMatch( e.Speech, "jeden wstecz", RegexOptions.IgnoreCase ) )
					{
						OneMove( Backward );
					}
				return;
				}
				bool actualSpeed = true;
				if ( Regex.IsMatch( e.Speech, "powoli", RegexOptions.IgnoreCase ) )
				{
					actualSpeed = false;
				}
				if ( Regex.IsMatch( e.Speech, "naprzod w lewo", RegexOptions.IgnoreCase ) )
				{
					StartMove( ForwardLeft, actualSpeed );
				}
				else if ( Regex.IsMatch( e.Speech, "naprzod w prawo", RegexOptions.IgnoreCase ) )
				{
					StartMove( ForwardRight, actualSpeed );
				}
				else if ( Regex.IsMatch( e.Speech, "wstecz w lewo", RegexOptions.IgnoreCase ) )
				{
					StartMove( BackwardLeft, actualSpeed );
				}
				else if ( Regex.IsMatch( e.Speech, "wstecz w prawo", RegexOptions.IgnoreCase ) )
				{
					StartMove( BackwardRight, actualSpeed );
				}
				else if ( Regex.IsMatch( e.Speech, "prawo", RegexOptions.IgnoreCase ) )
				{
					StartMove( Right, actualSpeed );
				}
				else if ( Regex.IsMatch( e.Speech, "lewo", RegexOptions.IgnoreCase ) )
				{
					StartMove( Left, actualSpeed );
				}
				else if ( Regex.IsMatch( e.Speech, "naprzod", RegexOptions.IgnoreCase ) )
				{
					StartMove( Forward, actualSpeed );
				}
				else if ( Regex.IsMatch( e.Speech, "wstecz", RegexOptions.IgnoreCase ) )
				{
					StartMove( Backward, actualSpeed );
				}
			}
		}
        // zombie
