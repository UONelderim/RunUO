...
namespace Server.Multis
{
    public abstract class BaseHouse : BaseMulti
    {
        ...
        public virtual bool CheckDecay()
        {
            ...
            {
                CommandLogging.WriteLine( Owner, "Deleting house of {0} [{1}] due to decay. Location: {2}", Owner.Name, Owner.Account.Username, Location.ToString());
        ...
        //Replaced by Knives.TownHouses version
            ...
            switch ( version )
            {
                ...
                case 12:
                {
                    ...
                    for ( int i = 0; i < relocatedCount; i++ )
                    {
                        ...
                        IEntity entity = World.FindEntity( (Serial)reader.ReadInt() );
