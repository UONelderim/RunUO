...
namespace Server.Spells.Ninjitsu
{
	public class AnimalForm : NinjaSpell
	{
		...
		public static MorphResult Morph( Mobile m, int entryID )
		{
			...
			m.CheckSkill( SkillName.Ninjitsu, 0.0, 30.0 );  // zeby bylo na czym koksac skilla od zera
			...
			*/
			...
			{
                // przyrost skilla na kazdej z form:
                if ( !m.CheckSkill( SkillName.Ninjitsu, entry.ReqSkill, entry.ReqSkill + 37.5 ))
                    return MorphResult.Fail;
        ...
        // 25.09.2012 :: zombie :: uzywane w ArenaRegion.cs
		...
		private static AnimalFormEntry[] m_Entries = new AnimalFormEntry[]
			{
				...
				new AnimalFormEntry( typeof( Rat ),          1018294,  8483, 2309, 1070805,  0.0, 0xEE,  true, false ),
				new AnimalFormEntry( typeof( Rabbit ),       1028485,  8485, 2309, 1070805,  0.0, 0xCD,  true, false )
			};
