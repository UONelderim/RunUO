...
namespace Server.Spells
{
	public abstract class Spell : ISpell
	{
		...
		public virtual bool ConsumeReagents()
		{
            ...
            // 05.07.2012 :: zombie ::  LRC nie dziala na spelle, ktore wymagaja PowderOfTranslocation
            // 15.01.2015 :: mortuus :: LRC dziala na wszystkie reagenty poza PowderOfTranslocation 
            //                          (TODO: obsluga ogolnej listy reagentow niewrazliwych na LRC)
            int powderRequired = 0;

            for ( int i=0; i< m_Info.Reagents.Length; ++i )
            {
                if ( m_Info.Reagents[i] == Reagent.PowderOfTranslocation )
                {
                    powderRequired = m_Info.Amounts[i];
                    break;
                }
            }
			...
			if ( AosAttributes.GetValue( m_Caster, AosAttribute.LowerRegCost ) > Utility.Random( 100 ) )
            {
                ...
                return pack != null && pack.ConsumeTotal( Reagent.PowderOfTranslocation, powderRequired );
            }
            // zombie
		...
		public virtual void SayMantra()
		{
            ...
            // 23.06.2012 :: zombie :: wlaczenie pokazywania spelli, ktore castuja moby
