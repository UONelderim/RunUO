...
namespace Server.Spells.Chivalry
{
	public class CloseWoundsSpell : PaladinSpell
	{
		...
		public override int MantraNumber{ get{ return 1060719; } } // Obsu Vulni (zmienione na: Otium Dolor)
		...
		public void Target( Mobile m )
		{
			...
			{
				Caster.SendLocalizedMessage( 1060178 ); // "Jestes za daleko."
			}
			...
			else if ( CheckBSequence( m ) )
			{
				...
				m.SendLocalizedMessage( 1060203, toHeal.ToString() ); // "Wyleczyles ~1_HEALED_AMOUNT~ punktow zdrowia."
