...
namespace Server.Spells.Chivalry
{
	public abstract class PaladinSpell : Spell
	{
		...
		public override bool CheckCast()
		{
			...
			{
				Caster.SendLocalizedMessage( 1060172, RequiredSkill.ToString( "F1" ) ); // "Potrzebujesz ~1_SKILL_REQUIREMENT~ Chivalry, zeby to zrobic."
				return false;
			}
		...
		public override bool CheckFizzle()
		{
			...
			{
				Caster.SendLocalizedMessage( 1060174, RequiredMana.ToString() ); // "Potrzebujesz ~1_MANA_REQUIREMENT~ many, zeby to zrobic."
				return false;
			}
		...
		{
            Caster.Emote("*"+Info.Mantra+"*");
			//Caster.PublicOverheadMessage( MessageType.Emote, 0x3B2, MantraNumber, "", false );
		}
