...
namespace Server.Spells.Necromancy
{
	public class AnimateDeadSpell : NecromancerSpell
	{
		...
		private static CreatureGroup[] m_Groups = new CreatureGroup[]
			{
				...
				}, new SummonEntry[]
				{
					...
					new SummonEntry(  3000, typeof( BoneKnight ) ),
					new SummonEntry(  2000, typeof( Mummy ) ),
					new SummonEntry(  1000, typeof( BoneMagi ) ),
		...
		public static void Register( Mobile master, Mobile summoned )
		{
            ...
            if ((BaseCreature)summoned is BaseMount)
            {
                Timer.DelayCall(TimeSpan.FromSeconds(120.0), TimeSpan.FromSeconds(120.0), new TimerStateCallback(Summoned_Damage), summoned);
            }
            else
            {
