...
namespace Server
{
	...
	public class Region : IComparable
	{
		...
		private static TimeSpan m_DefaultLogoutDelay = TimeSpan.FromMinutes( 2.0 );
		...
		internal static void Load()
		{
			...
			Console.Write( "Region: Wczytywanie..." );
			...
			Console.WriteLine( "Gotowe w {0:F1} sekundy.", (DateTime.Now - start).TotalSeconds );
		}
